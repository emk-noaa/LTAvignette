...
```{r, echo=TRUE, eval=TRUE, collapse=TRUE, fig.height=4, fig.width=7}
cruz_demo <- segmentize(cruz,
                        segment_method = 'equallength',
                        segment_target_km = 5,
                        segment_max_interval = .1,
