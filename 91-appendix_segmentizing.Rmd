...
```{r, echo=FALSE, eval=FALSE, collapse=TRUE, fig.width=7, fig.height=3.5}
...
Here is the `segmentize()` function parameterized with some basic settings: a target segment length of 30km, with the maximum allowable gap in effort within segments to be 24 hours.   

```{r, echo=TRUE, eval=TRUE, collapse=TRUE, fig.width=7, fig.height=7}
...
```{r, echo=TRUE, eval=TRUE, collapse=TRUE, fig.height=7, fig.width=7}
cruz_demo <- segmentize(cruz,
                        segment_method = 'equallength',
                        segment_target_km = 5,
                        segment_max_interval = .1,
