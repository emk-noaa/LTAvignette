...
Begin with a basic map of the waters surrounding the Hawaiian archipelago, including EEZ borders:  

```{r, echo=TRUE, eval=rerun_from_scratch, collapse=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_cnp.png', width=7, height=5, res=150, units='in')
m
dev.off()
```

![](img/map_cnp.png){width=95%}

We also have a base map for the California Current ... 

```{r, echo=TRUE, eval=rerun_from_scratch, collapse=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=5}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_ccs.png', width=7, height=5, res=150, units='in')
m
dev.off()
```

![](img/map_ccs.png){width=95%}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_etp.png', width=7, height=5, res=150, units='in')
m
dev.off()
```

![](img/map_etp.png){width=95%}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_cnp_strata.png', width=7, height=5, res=150, units='in')
m1
dev.off()
```

![](img/map_cnp_strata.png){width=95%}

### Add survey tracks {-}  

To demonstrate how to map data, we will use survey data from 2017 and 2020 within the WHICEAS study area:

```{r, echo=TRUE, eval=rerun_from_scratch, collapse=TRUE, include=TRUE}
# Load the cruz object we made in the "Processing" chapter
...
Here is the function that maps effort: 

```{r, echo=TRUE, eval=rerun_from_scratch, collapse=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
m1 <- map_effort(m, cruz_1720)
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_tracks.png', width=7, height=5, res=150, units='in')
m1
dev.off()
```

![](img/map_tracks.png){width=95%}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_tracks2.png', width=7, height=5, res=150, units='in')
m1
dev.off()
```

![](img/map_tracks2.png){width=95%}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_tracks3.png', width=7, height=5, res=150, units='in')
m_custom2
dev.off()
```

![](img/map_tracks3.png){width=95%}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_sits.png', width=7, height=5, res=150, units='in')
m1
dev.off()
```

![](img/map_sits.png){width=95%}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_sits2.png', width=7, height=5, res=150, units='in')
m1
dev.off()
```

![](img/map_sits2.png){width=95%}
...
```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_sits3.png', width=7, height=5, res=150, units='in')
m1
dev.off()
```

![](img/map_sits3.png){width=95%}
...
```{r, echo=TRUE, eval=rerun_from_scratch, collapse=TRUE, message=FALSE, warning=FALSE, fig.width=6, fig.height=4}
m <- map_base('cnp') 
m <- map_strata(m, cruz_1720$settings)
m <- map_effort(m, cruz_1720)
m <- map_sightings(m, cruz_1720, size_base=.4)
m 
```

```{r, echo=FALSE, eval=rerun_from_scratch}
png('img/map_overview.png', width=7, height=5, res=150, units='in')
m
dev.off()
```

![](img/map_overview.png){width=95%}
