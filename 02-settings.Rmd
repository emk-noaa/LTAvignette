...
- `study_area`: a single dataframe of coordinates    
...
- **`species:`** A character vector of species codes to include in this cohort. If `NULL` (the default), all species will be included.  
