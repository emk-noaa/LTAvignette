...
\DecValTok{1}\NormalTok{ all     HI_EEZ   }\DecValTok{19957} \FloatTok{0.00100} \FloatTok{0.0207} \FloatTok{0.0537} \FloatTok{0.130} \FloatTok{0.468} \FloatTok{0.286} \FloatTok{0.0412}
...
\NormalTok{g0_scenario <-}\StringTok{ }\DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{load_das}\NormalTok{(das_file, }\DataTypeTok{perform_checks =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{print_glimpse =} \OtherTok{FALSE}\NormalTok{)}\OperatorTok{:}\StringTok{ }\NormalTok{could not find }\ControlFlowTok{function} \StringTok{"load_das"}
\NormalTok{cruz <-}\StringTok{ }\KeywordTok{process_strata}\NormalTok{(das,}
\NormalTok{                       settings,}
                       \DataTypeTok{verbose=}\OtherTok{FALSE}\NormalTok{)}
\NormalTok{Error }\ControlFlowTok{in} \StringTok{`}\DataTypeTok{dplyr::filter()}\StringTok{`}\OperatorTok{:}
\OperatorTok{!}\StringTok{ }\NormalTok{Problem }\ControlFlowTok{while}\NormalTok{ computing }\StringTok{`}\DataTypeTok{..1 = !is.na(Lon) & !is.na(Lat)}\StringTok{`}\NormalTok{.}
\NormalTok{Caused by error}\OperatorTok{:}
\OperatorTok{!}\StringTok{ }\NormalTok{object }\StringTok{'Lon'}\NormalTok{ not found}
\NormalTok{cruz <-}\StringTok{ }\KeywordTok{format_das}\NormalTok{(cruz)}
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{format_das}\NormalTok{(cruz)}\OperatorTok{:}\StringTok{ }\NormalTok{could not find }\ControlFlowTok{function} \StringTok{"format_das"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{cruz_demo <-}\StringTok{ }\KeywordTok{segmentize}\NormalTok{(cruz,}
                        ...
                        \DataTypeTok{verbose=}\OtherTok{FALSE}\NormalTok{)}
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{UseMethod}\NormalTok{(}\StringTok{"mutate"}\NormalTok{)}\OperatorTok{:}\StringTok{ }\NormalTok{no applicable method }\ControlFlowTok{for} \StringTok{'mutate'}\NormalTok{ applied to an object of class }\StringTok{"list"}
