...
\ErrorTok{$}\StringTok{ }\NormalTok{yday         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{37}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{44}\NormalTok{, }\DecValTok{49}\NormalTok{, }\DecValTok{49}\NormalTok{, }\DecValTok{55}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{43}\NormalTok{, }\DecValTok{46}\NormalTok{, }\DecValTok{47}\NormalTok{, }\DecValTok{48}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{3}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{dist         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{149.851072}\NormalTok{, }\FloatTok{149.959115}\NormalTok{, }\FloatTok{149.869334}\NormalTok{, }\FloatTok{4.154102}\NormalTok{, }\FloatTok{149.562750}\NormalTok{,}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{21.99817}\NormalTok{, }\FloatTok{21.14833}\NormalTok{, }\FloatTok{19.17733}\NormalTok{, }\FloatTok{20.36950}\NormalTok{, }\FloatTok{20.40850}\NormalTok{, }\FloatTok{21.7600}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-159.1487}\NormalTok{, }\FloatTok{-158.0103}\NormalTok{, }\FloatTok{-156.0610}\NormalTok{, }\FloatTok{-155.6150}\NormalTok{, }\FloatTok{-156.1288}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
...
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp1   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1233905632}\NormalTok{, }\DecValTok{1234258869}\NormalTok{, }\DecValTok{1234545197}\NormalTok{, }\DecValTok{1234969984}\NormalTok{, }\DecValTok{123498100}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{21.14850}\NormalTok{, }\FloatTok{19.18117}\NormalTok{, }\FloatTok{20.36850}\NormalTok{, }\FloatTok{20.40850}\NormalTok{, }\FloatTok{21.76150}\NormalTok{, }\FloatTok{21.6810}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-158.0097}\NormalTok{, }\FloatTok{-156.0583}\NormalTok{, }\FloatTok{-155.6035}\NormalTok{, }\FloatTok{-156.1288}\NormalTok{, }\FloatTok{-157.2517}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{DateTime2    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-10} \DecValTok{09}\OperatorTok{:}\DecValTok{40}\OperatorTok{:}\DecValTok{54}\NormalTok{, }\DecValTok{2009-02-13} \DecValTok{17}\OperatorTok{:}\DecValTok{11}\OperatorTok{:}\DecValTok{22}\NormalTok{, }\DecValTok{2009-02-18} \DecValTok{15}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp2   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1234258854}\NormalTok{, }\DecValTok{1234545082}\NormalTok{, }\DecValTok{1234969744}\NormalTok{, }\DecValTok{1234981000}\NormalTok{, }\DecValTok{123549202}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlat         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{19.57617}\NormalTok{, }\FloatTok{21.37917}\NormalTok{, }\FloatTok{19.80383}\NormalTok{, }\FloatTok{20.36500}\NormalTok{, }\FloatTok{22.46000}\NormalTok{, }\FloatTok{21.7095}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlon         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-156.0153}\NormalTok{, }\FloatTok{-160.3327}\NormalTok{, }\FloatTok{-155.0400}\NormalTok{, }\FloatTok{-155.7462}\NormalTok{, }\FloatTok{-160.4300}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mDateTime    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-08} \DecValTok{07}\OperatorTok{:}\DecValTok{57}\OperatorTok{:}\DecValTok{43}\NormalTok{, }\DecValTok{2009-02-11} \DecValTok{10}\OperatorTok{:}\DecValTok{36}\OperatorTok{:}\DecValTok{04}\NormalTok{, }\DecValTok{2009-02-16} \DecValTok{07}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mtimestamp   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1233905632}\NormalTok{, }\DecValTok{1234258869}\NormalTok{, }\DecValTok{1234545197}\NormalTok{, }\DecValTok{1234969984}\NormalTok{, }\DecValTok{123498100}\OperatorTok{~}
...
\StringTok{$ day          <int> 6, 10, 13, 18, 18, 24, 6, 6, 10, 12, 15, 16, 17, 6, 6, 7,~}
\StringTok{$ min_line     <int> 424489, 425732, 426950, 428291, 428376, 429786, 424728, 4~}
\StringTok{$ max_line     <int> 425731, 426949, 428283, 428375, 429785, 429845, 424824, 4~}
\StringTok{$ n_rows       <int> 588, 606, 618, 19, 520, 38, 74, 31, 51, 211, 62, 22, 95, ~}
\StringTok{$ avgBft       <dbl> 3.937522, 2.669176, 4.188039, 5.000000, 5.318873, 6.61395~}
\StringTok{$ avgSwellHght <dbl> 3.665611, 2.942091, 4.269515, 5.000000, 5.762063, 7.38604~}
\StringTok{$ avgHorizSun  <dbl> 5.476773, 5.353724, 7.496408, 10.407375, 4.988936, NaN, 4~}
\StringTok{$ avgVertSun   <dbl> 1.510175, 1.636948, 1.651676, 1.407375, 1.465219, NaN, 1.~}
\StringTok{$ avgGlare     <dbl> 0.01104594, 0.24518732, 0.10290961, 0.40737545, 0.0000000~}
\StringTok{$ avgVis       <dbl> 6.707940, 5.875014, 5.592262, 6.500000, 5.800907, 6.19302~}
\StringTok{$ avgCourse    <dbl> 182.50032, 153.27848, 201.25267, 239.48112, 166.43485, 10~}
\StringTok{$ avgSpdKt     <dbl> 8.296386, 9.165131, 9.411149, 9.229142, 9.292142, 8.62279~}
\end{Highlighting}
\end{Shaded}
...
\ErrorTok{$}\StringTok{ }\NormalTok{seg_id           }\OperatorTok{<}\NormalTok{int}\OperatorTok{>}\StringTok{ }\DecValTok{34}\NormalTok{, }\DecValTok{35}\NormalTok{, }\DecValTok{35}\NormalTok{, }\DecValTok{35}\NormalTok{, }\DecValTok{36}\NormalTok{, }\DecValTok{36}\NormalTok{, }\DecValTok{36}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{29}\NormalTok{, }\DecValTok{38}\NormalTok{, }\DecValTok{38}\NormalTok{, }\DecValTok{3}\OperatorTok{~}
...
\includegraphics{figures/unnamed-chunk-69-1.pdf}
...
\includegraphics{figures/unnamed-chunk-70-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{map_strata}\NormalTok{(m,}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{map_effort}\NormalTok{(m, }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{map_sightings}\NormalTok{(m, cruz_}\DecValTok{1720}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{                    title             scientific          species truncation}
...
\includegraphics{figures/unnamed-chunk-166-1.pdf} \includegraphics{figures/unnamed-chunk-166-2.pdf}
...
\includegraphics{figures/unnamed-chunk-166-3.pdf} \includegraphics{figures/unnamed-chunk-166-4.pdf} \includegraphics{figures/unnamed-chunk-166-5.pdf}
...
\includegraphics{figures/unnamed-chunk-166-6.pdf} \includegraphics{figures/unnamed-chunk-166-7.pdf}
...
\includegraphics{figures/unnamed-chunk-166-8.pdf}
...
\NormalTok{(ltas_2b }\OperatorTok{%>%}\StringTok{ }\KeywordTok{lta_report}\NormalTok{(}\DataTypeTok{verbose=}\OtherTok{FALSE}\NormalTok{))}\OperatorTok{$}\NormalTok{table4}
                         \DecValTok{2002}\NormalTok{  (HI_EEZ)                      }\DecValTok{2010}\NormalTok{  (HI_EEZ)}
\DecValTok{1}\NormalTok{ Species or category Density Abundance  CV        }\DecValTok{95}\NormalTok{% CI Density Abundance}
\DecValTok{2}\NormalTok{     Striped dolphin   }\FloatTok{14.02}    \DecValTok{34}\NormalTok{,}\DecValTok{691} \FloatTok{0.4} \DecValTok{17}\NormalTok{,}\DecValTok{882-75}\NormalTok{,}\DecValTok{136}   \FloatTok{23.86}    \DecValTok{59}\NormalTok{,}\DecValTok{051}
...
\hypertarget{false-killer-whales}{%
\chapter{False killer whales}\label{false-killer-whales}}
