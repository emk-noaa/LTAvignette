...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP, Bottlenose_BI, Bottlenose_OUFI, Bottlenose_KaNi}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{2050} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{148.6}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329632}\NormalTok{ data rows}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP, Spotted_OU, Spotted_FI, Spotted_BI}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{2051} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{148.6}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329632}\NormalTok{ data rows}
...
\includegraphics{figures/unnamed-chunk-178-2.pdf} \includegraphics{figures/unnamed-chunk-178-3.pdf} \includegraphics{figures/unnamed-chunk-178-4.pdf} \includegraphics{figures/unnamed-chunk-178-5.pdf} \includegraphics{figures/unnamed-chunk-178-6.pdf} \includegraphics{figures/unnamed-chunk-178-7.pdf} \includegraphics{figures/unnamed-chunk-178-8.pdf} \includegraphics{figures/unnamed-chunk-178-9.pdf} \includegraphics{figures/unnamed-chunk-178-10.pdf} \includegraphics{figures/unnamed-chunk-178-11.pdf} \includegraphics{figures/unnamed-chunk-178-12.pdf}
...
\DecValTok{1}\NormalTok{ Frasers d}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{026}             \DecValTok{10}   \OtherTok{NaN}      \FloatTok{0.454} \FloatTok{0.777} \FloatTok{3030.} \DecValTok{0}     
\DecValTok{2}\NormalTok{ Frasers d}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{026}             \DecValTok{10}     \FloatTok{3.44}   \FloatTok{0.482} \FloatTok{0.763} \FloatTok{4427.} \FloatTok{0.0615}
\DecValTok{3}\NormalTok{ Melon}\OperatorTok{-}\NormalTok{hea}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{031}             \DecValTok{10}     \FloatTok{3.02}   \FloatTok{0.628} \FloatTok{0.409} \FloatTok{3030.} \FloatTok{0.144} 
\DecValTok{4}\NormalTok{ Melon}\OperatorTok{-}\NormalTok{hea}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{031}             \DecValTok{10}     \FloatTok{3.26}   \FloatTok{0.633} \FloatTok{0.417} \FloatTok{4427.} \FloatTok{0.205} 
\DecValTok{5}\NormalTok{ Striped d}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{013}             \DecValTok{10}     \FloatTok{3.49}   \FloatTok{0.479} \FloatTok{0.144} \FloatTok{3030.} \FloatTok{0.0406}
\DecValTok{6}\NormalTok{ Striped d}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{013}             \DecValTok{10}     \FloatTok{3.37}   \FloatTok{0.499} \FloatTok{0.184} \FloatTok{4427.} \FloatTok{0.0502}
...
\CommentTok{# Number of segments}
\NormalTok{cruz_demo}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{default}\OperatorTok{$}\NormalTok{segments }\OperatorTok{%>%}\StringTok{ }\NormalTok{nrow}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1826}
