...
\NormalTok{Rows}\SpecialCharTok{:} \DecValTok{1}\NormalTok{,}\DecValTok{889}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1889}
...
\NormalTok{            geostrata}\SpecialCharTok{:}\NormalTok{ WHICEAS, HI\_EEZ, OtherCNP}
            \SpecialCharTok{$}\NormalTok{segments  }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{1889} \FunctionTok{segments}\NormalTok{ (}\AttributeTok{median =} \FloatTok{149.3}\NormalTok{ km)}
            \SpecialCharTok{$}\NormalTok{das       }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{329638}\NormalTok{ data rows}
...
\NormalTok{            geostrata}\SpecialCharTok{:}\NormalTok{ WHICEAS, HI\_EEZ, OtherCNP, Bottlenose\_BI, Bottlenose\_OUFI, Bottlenose\_KaNi}
            \SpecialCharTok{$}\NormalTok{segments  }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{2051} \FunctionTok{segments}\NormalTok{ (}\AttributeTok{median =} \FloatTok{148.7}\NormalTok{ km)}
            \SpecialCharTok{$}\NormalTok{das       }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{329638}\NormalTok{ data rows}
...
\NormalTok{            geostrata}\SpecialCharTok{:}\NormalTok{ WHICEAS, HI\_EEZ, OtherCNP, Spotted\_OU, Spotted\_FI, Spotted\_BI}
            \SpecialCharTok{$}\NormalTok{segments  }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{2056} \FunctionTok{segments}\NormalTok{ (}\AttributeTok{median =} \FloatTok{148.5}\NormalTok{ km)}
            \SpecialCharTok{$}\NormalTok{das       }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{329638}\NormalTok{ data rows}
...
\addcontentsline{toc}{paragraph}{Cruise 1621-073}
...
\NormalTok{das\_file }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}data/surveys/CenPac1986{-}2020\_Final\_alb.das\textquotesingle{}}
\NormalTok{das }\OtherTok{\textless{}{-}} \FunctionTok{das\_readtext}\NormalTok{(das\_file)}
\NormalTok{i }\OtherTok{\textless{}{-}} \FunctionTok{which}\NormalTok{(}\FunctionTok{substr}\NormalTok{(das}\SpecialCharTok{$}\NormalTok{das, }\DecValTok{6}\NormalTok{, }\DecValTok{18}\NormalTok{) }\SpecialCharTok{==} \StringTok{\textquotesingle{}141904 110802\textquotesingle{}}\NormalTok{)}
\NormalTok{das}\SpecialCharTok{$}\NormalTok{das[i]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"129S.141904 110802 N22:32.34 W171:45.83  275  208    6    4  093  0.5 2.75"}
\NormalTok{[}\DecValTok{2}\NormalTok{] }\StringTok{"130A.141904 110802 N22:32.34 W171:45.83  275         Y    N  073"}          
\end{Highlighting}
\end{Shaded}
...
\NormalTok{            geostrata}\SpecialCharTok{:}\NormalTok{ WHICEAS, HI\_EEZ, OtherCNP}
            ...
            \SpecialCharTok{$}\NormalTok{das       }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{329638}\NormalTok{ data rows}
            \SpecialCharTok{$}\NormalTok{sightings }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{3934}\NormalTok{ detections}
            \SpecialCharTok{$}\NormalTok{subgroups }\SpecialCharTok{{-}{-}{-}}\NormalTok{ with }\DecValTok{237}\NormalTok{ subgroups, }\DecValTok{37}\NormalTok{ sightings, and }\DecValTok{345}\NormalTok{ events}
...
\includegraphics{figures/unnamed-chunk-240-2.pdf} \includegraphics{figures/unnamed-chunk-240-3.pdf} \includegraphics{figures/unnamed-chunk-240-4.pdf} \includegraphics{figures/unnamed-chunk-240-5.pdf} \includegraphics{figures/unnamed-chunk-240-6.pdf} \includegraphics{figures/unnamed-chunk-240-7.pdf} \includegraphics{figures/unnamed-chunk-240-8.pdf} \includegraphics{figures/unnamed-chunk-240-9.pdf} \includegraphics{figures/unnamed-chunk-240-10.pdf} \includegraphics{figures/unnamed-chunk-240-11.pdf} \includegraphics{figures/unnamed-chunk-240-12.pdf}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{species\_translator}\NormalTok{(}\AttributeTok{id =}\NormalTok{ sizi}\SpecialCharTok{$}\NormalTok{species, }\AttributeTok{species\_codes =}\NormalTok{ spp\_codes)}\SpecialCharTok{:}\NormalTok{ unused }\FunctionTok{argument}\NormalTok{ (}\AttributeTok{species\_codes =}\NormalTok{ spp\_codes)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  DT}\SpecialCharTok{::}\FunctionTok{datatable}\NormalTok{(}\AttributeTok{options=}\FunctionTok{list}\NormalTok{(}\AttributeTok{initComplete =}\NormalTok{ htmlwidgets}\SpecialCharTok{::}\FunctionTok{JS}\NormalTok{(}
    \StringTok{"function(settings, json) \{$(this.api().table().container()).css(\{\textquotesingle{}font{-}size\textquotesingle{}: \textquotesingle{}9pt\textquotesingle{}\});\}"}\NormalTok{)}
\NormalTok{  ))}
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ crosstalk}\SpecialCharTok{::}\FunctionTok{is.SharedData}\NormalTok{(data)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}tables\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(expr, envir, enclos)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}reporti\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
