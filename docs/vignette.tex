...
The \texttt{R} package \texttt{LTabundR} offers tools that facilitate and standardize design-based line-transect abundance estimation of cetaceans, based on typical workflow used following NOAA Fisheries ship surveys in the central and eastern Pacific.
...
\begin{itemize}
\item
  This step involves reading in \& processing raw \texttt{DAS} files (the files produced by the software Wincruz commonly used during NOAA Fisheries line-transect surveys in the Pacific), breaking effort into discrete segments for variance estimation, correcting school size estimates according to calibration models, and then averaging together school size estimates for each sighting.
\item
...
\NormalTok{mine1 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Lon =} \KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{120}\NormalTok{, }\DecValTok{-125}\NormalTok{, }\DecValTok{-125}\NormalTok{, }\DecValTok{-120}\NormalTok{, }\DecValTok{120}\NormalTok{),}
                           \DataTypeTok{Lat =} \KeywordTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{,   }\DecValTok{20}\NormalTok{,   }\DecValTok{40}\NormalTok{,   }\DecValTok{40}\NormalTok{,   }\DecValTok{20}\NormalTok{))}

\CommentTok{# Make into a list}
\NormalTok{my_strata <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{mine1 =}\NormalTok{ mine1)}

\CommentTok{# Check it out}
\NormalTok{my_strata}
\OperatorTok{$}\NormalTok{mine1}
\NormalTok{   Lon Lat}
\DecValTok{1} \DecValTok{-120}  \DecValTok{20}
\DecValTok{2} \DecValTok{-125}  \DecValTok{20}
\DecValTok{3} \DecValTok{-125}  \DecValTok{40}
\DecValTok{4} \DecValTok{-120}  \DecValTok{40}
\DecValTok{5}  \DecValTok{120}  \DecValTok{20}

\CommentTok{# Supply to load_settings()}
\NormalTok{my_settings <-}\StringTok{ }\KeywordTok{load_settings}\NormalTok{(}\DataTypeTok{strata =}\NormalTok{ my_strata)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Subset `strata_cnp`:}
\NormalTok{my_cnp <-}\StringTok{ }\NormalTok{strata_cnp[}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{)]}

\CommentTok{# Check it out}
\NormalTok{my_cnp }\OperatorTok{%>%}\StringTok{ }\NormalTok{names}
...
\NormalTok{my_strata <-}\StringTok{ }\KeywordTok{c}\NormalTok{(my_cnp, }\KeywordTok{list}\NormalTok{(}\DataTypeTok{mine1 =}\NormalTok{ mine1))}
...
\NormalTok{das}\OperatorTok{$}\NormalTok{das }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{(}\DecValTok{20}\NormalTok{)}
...
Here is what this edit log object look like:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{edits}
\NormalTok{[[}\DecValTok{1}\NormalTok{]]}
\NormalTok{[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das_file}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"data/surveys/HICEASwinter2020.das"}

\NormalTok{[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{type}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"text"}

\NormalTok{[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{rows}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{10} \DecValTok{11} \DecValTok{12} \DecValTok{13} \DecValTok{14} \DecValTok{15}

\NormalTok{[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{chars}
...
\NormalTok{[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{edit}
...
\begin{Highlighting}[]
\CommentTok{# Before}
\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{9}\OperatorTok{:}\DecValTok{16}\NormalTok{]}
...
\CommentTok{# After}
\NormalTok{dase <-}\StringTok{ }\KeywordTok{das_editor}\NormalTok{(edits)}
\NormalTok{Applying edits to DAS file}\OperatorTok{:}\StringTok{ }\NormalTok{data}\OperatorTok{/}\NormalTok{surveys}\OperatorTok{/}\NormalTok{HICEASwinter2020.das}
\OperatorTok{---}\StringTok{ }\NormalTok{verbatim}\OperatorTok{/}\ControlFlowTok{function}\NormalTok{ text replacements ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{9}\OperatorTok{:}\DecValTok{16}\NormalTok{]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"009* 072752 011920 N21:50.58 W159:46.26"}                         
...
\begin{Highlighting}[]
\NormalTok{edits <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
                   \DataTypeTok{type =} \StringTok{'function'}\NormalTok{,}
                   \DataTypeTok{rows =} \DecValTok{10}\OperatorTok{:}\DecValTok{15}\NormalTok{, }
                   \DataTypeTok{chars =} \DecValTok{20}\OperatorTok{:}\DecValTok{39}\NormalTok{, }
                   \DataTypeTok{edit =} \StringTok{'tolower'}\NormalTok{))}
...
\NormalTok{edits <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
                   \DataTypeTok{type =} \StringTok{'function'}\NormalTok{,}
                   \DataTypeTok{rows =} \DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{, }
                   \DataTypeTok{chars =} \DecValTok{6}\OperatorTok{:}\DecValTok{40}\NormalTok{, }
                   \DataTypeTok{edit =} \StringTok{'function(x)\{das_time(x, tz_adjust = -1)$dt\}'}\NormalTok{))}

\CommentTok{# Before}
\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{1}\OperatorTok{:}\DecValTok{6}\NormalTok{]}
...
\OperatorTok{---}\StringTok{ }\NormalTok{verbatim}\OperatorTok{/}\ControlFlowTok{function}\NormalTok{ text replacements ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{1}\OperatorTok{:}\DecValTok{6}\NormalTok{]}
...
\NormalTok{edits <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
                   ...
                   \DataTypeTok{rows =} \DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{, }
                   \DataTypeTok{chars =} \DecValTok{6}\OperatorTok{:}\DecValTok{40}\NormalTok{, }
                   \DataTypeTok{edit =} \StringTok{'function(x)\{das_time(x, tz_adjust = "from utc")$dt\}'}\NormalTok{))}
...
\begin{Highlighting}[]
\NormalTok{edits <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
                    \DataTypeTok{type =} \StringTok{'move'}\NormalTok{,}
                    \DataTypeTok{rows =} \DecValTok{10}\NormalTok{, }
                    \DataTypeTok{chars =} \OtherTok{NULL}\NormalTok{, }
                    \DataTypeTok{edit =} \DecValTok{15}\NormalTok{))}
...
\NormalTok{dase <-}\StringTok{ }\KeywordTok{das_editor}\NormalTok{(edits)}
\NormalTok{Applying edits to DAS file}\OperatorTok{:}\StringTok{ }\NormalTok{data}\OperatorTok{/}\NormalTok{surveys}\OperatorTok{/}\NormalTok{HICEASwinter2020.das}
\OperatorTok{---}\StringTok{ }\NormalTok{move, copy}\OperatorTok{/}\NormalTok{paste, insertion, and deletion events ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{9}\OperatorTok{:}\DecValTok{16}\NormalTok{]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"009* 072752 011920 N21:50.58 W159:46.26"}                         
...
\CommentTok{# Before}
\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{9}\OperatorTok{:}\DecValTok{17}\NormalTok{]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"009* 072752 011920 N21:50.58 W159:46.26"}                         
\NormalTok{[}\DecValTok{2}\NormalTok{] }\StringTok{"010* 072952 011920 N21:50.91 W159:46.33"}                         
\NormalTok{[}\DecValTok{3}\NormalTok{] }\StringTok{"011B.073111 011920 N21:51.12 W159:46.36 2001    C  -10    N"}     
\NormalTok{[}\DecValTok{4}\NormalTok{] }\StringTok{"012R.073111 011920 N21:51.12 W159:46.36    F"}                    
...
\OperatorTok{---}\StringTok{ }\NormalTok{move, copy}\OperatorTok{/}\NormalTok{paste, insertion, and deletion events ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{9}\OperatorTok{:}\DecValTok{17}\NormalTok{]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"009* 072752 011920 N21:50.58 W159:46.26"}                         
\NormalTok{[}\DecValTok{2}\NormalTok{] }\StringTok{"010* 072952 011920 N21:50.91 W159:46.33"}                         
\NormalTok{[}\DecValTok{3}\NormalTok{] }\StringTok{"011B.073111 011920 N21:51.12 W159:46.36 2001    C  -10    N"}     
\NormalTok{[}\DecValTok{4}\NormalTok{] }\StringTok{"012R.073111 011920 N21:51.12 W159:46.36    F"}                    
...
\begin{Highlighting}[]
\NormalTok{edits <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
                   \DataTypeTok{type =} \StringTok{'insert'}\NormalTok{,}
                   \DataTypeTok{rows =} \DecValTok{10}\NormalTok{, }
                   \DataTypeTok{edit =} \StringTok{"SEQ* HHMMSS MMDDYY NDG:MI.NT WDEG:MI.NT"}\NormalTok{))}
\CommentTok{# Before}
\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{9}\OperatorTok{:}\DecValTok{16}\NormalTok{]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"009* 072752 011920 N21:50.58 W159:46.26"}                         
\NormalTok{[}\DecValTok{2}\NormalTok{] }\StringTok{"010* 072952 011920 N21:50.91 W159:46.33"}                         
...
\begin{Highlighting}[]
\NormalTok{edits <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
                   \DataTypeTok{type =} \StringTok{'delete'}\NormalTok{,}
                   \DataTypeTok{rows =} \DecValTok{10}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dase <-}\StringTok{ }\KeywordTok{das_editor}\NormalTok{(}\KeywordTok{list}\NormalTok{(edit_}\DecValTok{1607}\NormalTok{_}\DecValTok{55}\NormalTok{))}
\NormalTok{Applying edits to DAS file}\OperatorTok{:}\StringTok{ }\NormalTok{data}\OperatorTok{/}\NormalTok{surveys}\OperatorTok{/}\NormalTok{CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb.das}
\OperatorTok{---}\StringTok{ }\NormalTok{move, copy}\OperatorTok{/}\NormalTok{paste, insertion, and deletion events ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{128111}\OperatorTok{:}\DecValTok{128123}\NormalTok{]}
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\StringTok{"022P 120643 041597 N37:00.08 W151:55.47  143  091  005"}                                   
\NormalTok{ [}\DecValTok{2}\NormalTok{] }\StringTok{"023C 120643 041597 N37:00.08 W151:55.47 both right and left on 7x and naked eye"}          
\NormalTok{ [}\DecValTok{3}\NormalTok{] }\StringTok{"024N 120643 041597 N37:00.08 W151:55.47  075 08.0"}                                        
\NormalTok{ [}\DecValTok{4}\NormalTok{] }\StringTok{"025W 120643 041597 N37:00.08 W151:55.47    1            310  6.0"}                         
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dase <-}\StringTok{ }\KeywordTok{das_editor}\NormalTok{(}\KeywordTok{list}\NormalTok{(edit_}\DecValTok{1607}\NormalTok{_}\DecValTok{68}\NormalTok{))}
\NormalTok{Applying edits to DAS file}\OperatorTok{:}\StringTok{ }\NormalTok{data}\OperatorTok{/}\NormalTok{surveys}\OperatorTok{/}\NormalTok{CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb.das}
\OperatorTok{---}\StringTok{ }\NormalTok{move, copy}\OperatorTok{/}\NormalTok{paste, insertion, and deletion events ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{129982}\OperatorTok{:}\DecValTok{129995}\NormalTok{]}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dase <-}\StringTok{ }\KeywordTok{das_editor}\NormalTok{(}\KeywordTok{list}\NormalTok{(edit_}\DecValTok{1621}\NormalTok{_}\DecValTok{245}\NormalTok{))}
\NormalTok{Applying edits to DAS file}\OperatorTok{:}\StringTok{ }\NormalTok{data}\OperatorTok{/}\NormalTok{surveys}\OperatorTok{/}\NormalTok{CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb.das}
\OperatorTok{---}\StringTok{ }\NormalTok{move, copy}\OperatorTok{/}\NormalTok{paste, insertion, and deletion events ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{271930}\OperatorTok{:}\DecValTok{271941}\NormalTok{]}
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\StringTok{"036E 085345 103002 N20:22.56 W160:02.21    U"}                                        
\NormalTok{ [}\DecValTok{2}\NormalTok{] }\StringTok{"037R.085346 103002 N20:22.56 W160:02.21    S"}                                        
\NormalTok{ [}\DecValTok{3}\NormalTok{] }\StringTok{"038P.085346 103002 N20:22.56 W160:02.21  126  224  200"}                              
\NormalTok{ [}\DecValTok{4}\NormalTok{] }\StringTok{"039V.085346 103002 N20:22.56 W160:02.21    5   07  000      21.0"}                    
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{edit_}\DecValTok{1004}\NormalTok{_utc <-}\StringTok{ }
\StringTok{  }\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
       \DataTypeTok{type =} \StringTok{'function'}\NormalTok{,}
       \DataTypeTok{rows =} \DecValTok{433327}\OperatorTok{:}\DecValTok{437666}\NormalTok{, }
       \DataTypeTok{chars =} \DecValTok{6}\OperatorTok{:}\DecValTok{39}\NormalTok{, }
       \DataTypeTok{edit =} \StringTok{'function(x)\{das_time(x, tz_adjust = "from utc")$dt\}'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Before}
\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{433326}\OperatorTok{:}\DecValTok{433330}\NormalTok{] }\CommentTok{# bginning of cruise}
...
\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{437664}\OperatorTok{:}\DecValTok{437667}\NormalTok{] }\CommentTok{# end of cruise}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{433326}\OperatorTok{:}\DecValTok{433330}\NormalTok{]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"229* 181728 020510 N13:14.49 E145:00.34"}
...
\NormalTok{dase}\OperatorTok{$}\NormalTok{das[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{437664}\OperatorTok{:}\DecValTok{437667}\NormalTok{]}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{edit_}\DecValTok{1004}\NormalTok{_gmt10 <-}\StringTok{ }
\StringTok{  }\KeywordTok{list}\NormalTok{(}\DataTypeTok{das_file =}\NormalTok{ das_file, }
       \DataTypeTok{type =} \StringTok{'function'}\NormalTok{,}
       \DataTypeTok{rows =} \DecValTok{433327}\OperatorTok{:}\DecValTok{437665}\NormalTok{, }
       \DataTypeTok{chars =} \DecValTok{6}\OperatorTok{:}\DecValTok{39}\NormalTok{, }
       \DataTypeTok{edit =} \StringTok{'function(x)\{das_time(x, tz_adjust = 10)$dt\}'}\NormalTok{)}

\NormalTok{dase <-}\StringTok{ }\KeywordTok{das_editor}\NormalTok{(}\KeywordTok{list}\NormalTok{(edit_}\DecValTok{1004}\NormalTok{_gmt10))}
\NormalTok{Applying edits to DAS file}\OperatorTok{:}\StringTok{ }\NormalTok{data}\OperatorTok{/}\NormalTok{surveys}\OperatorTok{/}\NormalTok{CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb.das}
\OperatorTok{---}\StringTok{ }\NormalTok{verbatim}\OperatorTok{/}\ControlFlowTok{function}\NormalTok{ text replacements ...}
\OperatorTok{---}\StringTok{ }\OperatorTok{---}\StringTok{ }\NormalTok{working on edit }\DecValTok{1}\NormalTok{ ...}
...
\NormalTok{Rows}\OperatorTok{:}\StringTok{ }\DecValTok{1}\NormalTok{,}\DecValTok{890}
...
\ErrorTok{$}\StringTok{ }\NormalTok{yday         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{37}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{44}\NormalTok{, }\DecValTok{49}\NormalTok{, }\DecValTok{51}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{43}\NormalTok{, }\DecValTok{46}\NormalTok{, }\DecValTok{47}\NormalTok{, }\DecValTok{48}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{3}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{dist         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{149.851072}\NormalTok{, }\FloatTok{3.848268}\NormalTok{, }\FloatTok{149.477608}\NormalTok{, }\FloatTok{150.656675}\NormalTok{, }\FloatTok{16.254889}\NormalTok{, }\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{21.99817}\NormalTok{, }\FloatTok{21.14833}\NormalTok{, }\FloatTok{21.14817}\NormalTok{, }\FloatTok{19.19833}\NormalTok{, }\FloatTok{20.40850}\NormalTok{, }\FloatTok{21.4130}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-159.1487}\NormalTok{, }\FloatTok{-158.0103}\NormalTok{, }\FloatTok{-158.0943}\NormalTok{, }\FloatTok{-156.0760}\NormalTok{, }\FloatTok{-156.1288}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{DateTime1    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-06} \DecValTok{07}\OperatorTok{:}\DecValTok{33}\OperatorTok{:}\DecValTok{52}\NormalTok{, }\DecValTok{2009-02-10} \DecValTok{09}\OperatorTok{:}\DecValTok{41}\OperatorTok{:}\DecValTok{09}\NormalTok{, }\DecValTok{2009-02-10} \DecValTok{10}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp1   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1233905632}\NormalTok{, }\DecValTok{1234258869}\NormalTok{, }\DecValTok{1234262132}\NormalTok{, }\DecValTok{1234548006}\NormalTok{, }\DecValTok{123498100}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{21.14850}\NormalTok{, }\FloatTok{21.14967}\NormalTok{, }\FloatTok{19.19783}\NormalTok{, }\FloatTok{20.40850}\NormalTok{, }\FloatTok{21.41083}\NormalTok{, }\FloatTok{21.6810}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-158.0097}\NormalTok{, }\FloatTok{-158.0918}\NormalTok{, }\FloatTok{-156.0758}\NormalTok{, }\FloatTok{-156.1288}\NormalTok{, }\FloatTok{-157.2680}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{DateTime2    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-10} \DecValTok{09}\OperatorTok{:}\DecValTok{40}\OperatorTok{:}\DecValTok{54}\NormalTok{, }\DecValTok{2009-02-10} \DecValTok{10}\OperatorTok{:}\DecValTok{33}\OperatorTok{:}\DecValTok{32}\NormalTok{, }\DecValTok{2009-02-13} \DecValTok{17}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp2   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1234258854}\NormalTok{, }\DecValTok{1234262012}\NormalTok{, }\DecValTok{1234547957}\NormalTok{, }\DecValTok{1234981000}\NormalTok{, }\DecValTok{123514077}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlat         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{19.57617}\NormalTok{, }\FloatTok{21.16417}\NormalTok{, }\FloatTok{21.33983}\NormalTok{, }\FloatTok{19.80333}\NormalTok{, }\FloatTok{21.40417}\NormalTok{, }\FloatTok{21.9613}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlon         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-156.0153}\NormalTok{, }\FloatTok{-158.0875}\NormalTok{, }\FloatTok{-160.2627}\NormalTok{, }\FloatTok{-155.0388}\NormalTok{, }\FloatTok{-157.2693}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mDateTime    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-08} \DecValTok{07}\OperatorTok{:}\DecValTok{57}\OperatorTok{:}\DecValTok{43}\NormalTok{, }\DecValTok{2009-02-10} \DecValTok{10}\OperatorTok{:}\DecValTok{13}\OperatorTok{:}\DecValTok{32}\NormalTok{, }\DecValTok{2009-02-11} \DecValTok{11}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mtimestamp   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1233905632}\NormalTok{, }\DecValTok{1234258869}\NormalTok{, }\DecValTok{1234262132}\NormalTok{, }\DecValTok{1234548006}\NormalTok{, }\DecValTok{123498100}\OperatorTok{~}
...
\StringTok{$ EffType      <chr> NA, "}\NormalTok{N}\StringTok{", "}\NormalTok{S}\StringTok{", "}\NormalTok{S}\StringTok{", "}\NormalTok{S}\StringTok{", "}\NormalTok{S}\StringTok{", "}\NormalTok{N}\StringTok{", "}\NormalTok{N}\StringTok{", "}\NormalTok{N}\StringTok{", "}\NormalTok{N}\StringTok{", "}\NormalTok{N}\StringTok{", "}\NormalTok{N}\StringTok{"~}
...
\StringTok{$ day          <int> 6, 10, 10, 13, 18, 20, 6, 6, 10, 12, 15, 16, 17, 6, 7, 7,~}
\StringTok{$ min_line     <int> 424489, 425732, 425764, 426976, 428376, 428554, 424728, 4~}
\StringTok{$ max_line     <int> 425731, 425763, 426975, 428375, 428553, 429845, 424824, 4~}
\StringTok{$ n_rows       <int> 588, 21, 611, 611, 82, 476, 74, 31, 51, 211, 62, 22, 95, ~}
\StringTok{$ avgBft       <dbl> 3.937522, 2.000000, 2.693855, 4.236977, 5.650836, 5.42778~}
\StringTok{$ avgSwellHght <dbl> 3.665611, 2.000000, 2.990173, 4.295680, 6.000000, 5.91794~}
\StringTok{$ avgHorizSun  <dbl> 5.476773, 7.386038, 5.251324, 7.670550, 7.650836, 4.41183~}
\StringTok{$ avgVertSun   <dbl> 1.510175, 2.806981, 1.581961, 1.660281, 1.000000, 1.56607~}
\StringTok{$ avgGlare     <dbl> 0.01104594, 0.00000000, 0.24616396, 0.11466734, 0.0000000~}
\StringTok{$ avgVis       <dbl> 6.707940, 6.500000, 5.839215, 5.630527, 6.500000, 5.76905~}
\StringTok{$ avgCourse    <dbl> 182.5003, 244.8516, 149.4506, 204.8376, 284.8100, 147.147~}
\StringTok{$ avgSpdKt     <dbl> 8.296386, 7.427145, 9.226427, 9.395206, 9.681004, 9.17516~}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Rows}\OperatorTok{:}\StringTok{ }\DecValTok{3}\NormalTok{,}\DecValTok{934}
...
\StringTok{$ ss_valid         <lgl> TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE,~}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{1890} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{149.3}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329632}\NormalTok{ data rows}
            \OperatorTok{$}\NormalTok{sightings }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{3934}\NormalTok{ detections}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP, Bottlenose_BI, Bottlenose_OUFI, Bottlenose_KaNi}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{2049} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{148.6}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329632}\NormalTok{ data rows}
            \OperatorTok{$}\NormalTok{sightings }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{523}\NormalTok{ detections}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP, Spotted_OU, Spotted_FI, Spotted_BI}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{2057} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{148.5}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329632}\NormalTok{ data rows}
...
\begin{Highlighting}[]
\NormalTok{abund <-}
\StringTok{  }\NormalTok{SIGHTS }\OperatorTok{%>%}
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{pivot_longer}\NormalTok{(}\DataTypeTok{cols =} \DecValTok{31}\OperatorTok{:}\DecValTok{101}\NormalTok{,}
                      \DataTypeTok{names_to =} \StringTok{'species'}\NormalTok{,}
                      \DataTypeTok{values_to =} \StringTok{'best'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(best }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Region =} \KeywordTok{gsub}\NormalTok{(}\StringTok{' '}\NormalTok{,}\StringTok{''}\NormalTok{,Region)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{DateTime =} \KeywordTok{paste0}\NormalTok{(Yr,}\StringTok{'-'}\NormalTok{,Mo,}\StringTok{'-'}\NormalTok{,Da,}\StringTok{' '}\NormalTok{,Hr,}\StringTok{':'}\NormalTok{,Min))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{abund_summ <-}
\StringTok{  }\NormalTok{abund }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(}\DataTypeTok{cruise =}\NormalTok{ CruzNo, species) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{ntot_abund =} \KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{nsys_abund =} \KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{Region }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'NONE'}\NormalTok{, }
                                                      \StringTok{'Off-Transect'}\NormalTok{) }\OperatorTok{&}\StringTok{ }
\StringTok{                                        }\NormalTok{EffortSeg }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{))) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{species =} \KeywordTok{gsub}\NormalTok{(}\StringTok{'SP'}\NormalTok{,}\StringTok{''}\NormalTok{,species))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ltabundr <-}\StringTok{ }
\StringTok{  }\NormalTok{cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Filter out species that ABUND ignored based on its INP file}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{species }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'CU'}\NormalTok{, }\StringTok{'PU'}\NormalTok{))}
  
\NormalTok{ltabundr_summ <-}
\StringTok{  }\NormalTok{ltabundr }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(OnEffort }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(}\DataTypeTok{cruise =}\NormalTok{ Cruise, species) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{ntot_ltabundr =} \KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{nsys_ltabundr =} \KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(included }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE} \OperatorTok{&}\StringTok{ }
\StringTok{                                           }\NormalTok{EffType }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'S'}\NormalTok{,}\StringTok{'F'}\NormalTok{))))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mr <-}\StringTok{ }\KeywordTok{full_join}\NormalTok{(abund_summ, ltabundr_summ, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{'cruise'}\NormalTok{, }\StringTok{'species'}\NormalTok{))}

\NormalTok{mr }\OperatorTok{%>%}\StringTok{ }\NormalTok{head}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mr}\OperatorTok{$}\NormalTok{ntot_abund }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{3223}
\NormalTok{mr}\OperatorTok{$}\NormalTok{ntot_ltabundr }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mr}\OperatorTok{$}\NormalTok{nsys_abund }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2478}
\NormalTok{mr}\OperatorTok{$}\NormalTok{nsys_ltabundr }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bads <-}\StringTok{ }\KeywordTok{which}\NormalTok{(mr}\OperatorTok{$}\NormalTok{nsys_abund }\OperatorTok{!=}\StringTok{ }\NormalTok{mr}\OperatorTok{$}\NormalTok{nsys_ltabundr }\OperatorTok{|}\StringTok{ }
\StringTok{              }\NormalTok{mr}\OperatorTok{$}\NormalTok{ntot_abund }\OperatorTok{!=}\StringTok{ }\NormalTok{mr}\OperatorTok{$}\NormalTok{ntot_ltabundr }\OperatorTok{|}\StringTok{ }
\StringTok{              }\KeywordTok{is.na}\NormalTok{(mr}\OperatorTok{$}\NormalTok{ntot_abund) }\OperatorTok{|}\StringTok{ }
\StringTok{              }\KeywordTok{is.na}\NormalTok{(mr}\OperatorTok{$}\NormalTok{ntot_ltabundr) }\OperatorTok{|}\StringTok{ }
\StringTok{              }\KeywordTok{is.na}\NormalTok{(mr}\OperatorTok{$}\NormalTok{nsys_abund) }\OperatorTok{|}\StringTok{ }
\StringTok{              }\KeywordTok{is.na}\NormalTok{(mr}\OperatorTok{$}\NormalTok{nsys_ltabundr))}
\NormalTok{bads }\OperatorTok{%>%}\StringTok{ }\NormalTok{length}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sight_compare <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(abund, ltabundr, cruise, spp)\{}
  \KeywordTok{message}\NormalTok{(}\StringTok{'ABUND:'}\NormalTok{)}
\NormalTok{  abund }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(CruzNo }\OperatorTok{==}\StringTok{ }\NormalTok{cruise, species }\OperatorTok{==}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'SP'}\NormalTok{,spp)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(}\DecValTok{5}\NormalTok{, }\DecValTok{34}\NormalTok{, }\DecValTok{26}\NormalTok{, }\DecValTok{29}\NormalTok{, }\DecValTok{33}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{use_sit =}\NormalTok{ EffortSeg }\OperatorTok{!=}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{EffortSeg) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(use_sit)) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{print}

\NormalTok{  abund }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(CruzNo }\OperatorTok{==}\StringTok{ }\DecValTok{1631}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pull}\NormalTok{(species) }\OperatorTok{%>%}\StringTok{ }\NormalTok{table}
  
  
  \KeywordTok{message}\NormalTok{(}\StringTok{'}\CharTok{\textbackslash{}n}\StringTok{LTabundR:'}\NormalTok{)}
\NormalTok{  ltabundr }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(Cruise }\OperatorTok{==}\StringTok{ }\NormalTok{cruise, species }\OperatorTok{==}\StringTok{ }\NormalTok{spp) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(}\DecValTok{6}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{13}\NormalTok{, }\DecValTok{73}\NormalTok{, }\DecValTok{69}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{86}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{use_sit =}\NormalTok{ included, }\DataTypeTok{use_effort =}\NormalTok{ use) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(use_effort)) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{tibble }\OperatorTok{%>%}\StringTok{ }\NormalTok{print}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(ltabundr }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Cruise }\OperatorTok{==}\StringTok{ }\DecValTok{1203}\NormalTok{, species }\OperatorTok{==}\StringTok{ '015'}\NormalTok{))[}\DecValTok{1}\NormalTok{,]}
...
\DecValTok{1}      \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{         }\OtherTok{NA}     \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{     }\OtherTok{NA}
\NormalTok{  PerpDistKm species best low high  prob mixed   ss_tot lnsstot ss_percent n_sp}
\DecValTok{1}     \FloatTok{0.1852}     \DecValTok{015}    \DecValTok{1} \OtherTok{NaN}  \OtherTok{NaN} \OtherTok{FALSE}  \OtherTok{TRUE} \FloatTok{6.956522} \FloatTok{1.93968}        \OtherTok{NaN}    \DecValTok{2}
\NormalTok{  n_obs n_best n_low n_high calibr ss_valid mixed_max spp_max included}
\DecValTok{1}     \DecValTok{1}      \DecValTok{1}     \DecValTok{1}      \DecValTok{1}   \OtherTok{TRUE}    \OtherTok{FALSE}     \OtherTok{FALSE}    \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{     }\OtherTok{TRUE}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{das_file <-}\StringTok{ 'data/surveys/CenPac1986-2020_Final_alb.das'}
\NormalTok{das <-}\StringTok{ }\KeywordTok{das_readtext}\NormalTok{(das_file)}
\NormalTok{i <-}\StringTok{ }\KeywordTok{which}\NormalTok{(}\KeywordTok{substr}\NormalTok{(das}\OperatorTok{$}\NormalTok{das, }\DecValTok{6}\NormalTok{, }\DecValTok{18}\NormalTok{) }\OperatorTok{==}\StringTok{ '131944 051312'}\NormalTok{)}
\NormalTok{das}\OperatorTok{$}\NormalTok{das[i]}
...
\NormalTok{[}\DecValTok{6}\NormalTok{] }\StringTok{"269C.131944 051312 N11:58.04 W161:10.36  begin PC protool, first sighting is subgroup 'A', acoustics already tracking        "}                   
...
We see that this was a sighting of false killer whales during which species \texttt{015} was picked up during photo-ID. This discrepancy, then, may not be a mistake in the \texttt{LTabundR} processing.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(ltabundr }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Cruise }\OperatorTok{==}\StringTok{ }\DecValTok{1203}\NormalTok{, species }\OperatorTok{==}\StringTok{ '049'}\NormalTok{))[}\DecValTok{2}\NormalTok{,]}
\NormalTok{  Event            DateTime      Lat       Lon OnEffort Cruise Mode OffsetGMT}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{i <-}\StringTok{ }\KeywordTok{which}\NormalTok{(}\KeywordTok{substr}\NormalTok{(das}\OperatorTok{$}\NormalTok{das, }\DecValTok{6}\NormalTok{, }\DecValTok{18}\NormalTok{) }\OperatorTok{==}\StringTok{ '105409 050712'}\NormalTok{)}
\NormalTok{das}\OperatorTok{$}\NormalTok{das[(i[}\DecValTok{1}\NormalTok{] }\OperatorTok{-}\StringTok{ }\DecValTok{10}\NormalTok{)}\OperatorTok{:}\NormalTok{(i[}\DecValTok{1}\NormalTok{] }\OperatorTok{+}\StringTok{ }\DecValTok{3}\NormalTok{)]}
...
\CommentTok{# ... with abbreviated variable name 1: use_effort}
\NormalTok{(ltabundr }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Cruise }\OperatorTok{==}\StringTok{ }\DecValTok{1165}\NormalTok{, species }\OperatorTok{==}\StringTok{ '047'}\NormalTok{))[}\DecValTok{1}\NormalTok{,]}
\NormalTok{  Event            DateTime  Lat       Lon OnEffort Cruise Mode OffsetGMT}
...
\NormalTok{  SightNo Subgroup SightNoDaily Obs ObsStd Bearing Reticle DistNm Cue Method}
\DecValTok{1}      \DecValTok{07}     \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{   }\DecValTok{19880730}\NormalTok{_}\DecValTok{9} \DecValTok{051}   \OtherTok{TRUE}      \DecValTok{45}    \FloatTok{3.38}    \FloatTok{0.9}   \DecValTok{3}      \DecValTok{4}
\NormalTok{  Photos Birds CalibSchool PhotosAerial Biopsy CourseSchool TurtleSp TurtleGs}
\DecValTok{1}   \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{     }\NormalTok{N        }\OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{         }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{           }\OtherTok{NA}     \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\OtherTok{NA}
\NormalTok{  TurtleJFR TurtleAge TurtleCapt PinnipedSp PinnipedGs BoatType BoatGs}
\DecValTok{1}      \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{         }\OtherTok{NA}     \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{     }\OtherTok{NA}
\NormalTok{  PerpDistKm species    best low     high  prob mixed  ss_tot   lnsstot}
\DecValTok{1}   \FloatTok{1.178606}     \DecValTok{047} \FloatTok{1.15942}   \DecValTok{1} \FloatTok{1.259921} \OtherTok{FALSE} \OtherTok{FALSE} \FloatTok{1.15942} \FloatTok{0.1479201}
\NormalTok{  ss_percent n_sp n_obs n_best n_low n_high calibr ss_valid mixed_max spp_max}
\DecValTok{1}          \DecValTok{1}    \DecValTok{1}     \DecValTok{3}      \DecValTok{3}     \DecValTok{3}      \DecValTok{3}   \OtherTok{TRUE}     \OtherTok{TRUE}      \OtherTok{TRUE}     \DecValTok{047}
\NormalTok{  included}
\DecValTok{1}     \OtherTok{TRUE}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# ... with abbreviated variable name 1: use_effort}
\NormalTok{(ltabundr }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Cruise }\OperatorTok{==}\StringTok{ }\DecValTok{1631}\NormalTok{, species }\OperatorTok{==}\StringTok{ '003'}\NormalTok{))}
\NormalTok{  Event            DateTime      Lat       Lon OnEffort Cruise Mode OffsetGMT}
...
\NormalTok{                       file_das line_num stratum_HI_EEZ stratum_OtherCNP}
\DecValTok{1}\NormalTok{ CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb.das   }\DecValTok{405216}           \OtherTok{TRUE}             \OtherTok{TRUE}
\NormalTok{  stratum_WHICEAS year month day yday km_int   km_cum ship stratum seg_id  use}
\DecValTok{1}            \OtherTok{TRUE} \DecValTok{2006}     \DecValTok{9}   \DecValTok{2}  \DecValTok{245}      \DecValTok{0} \FloatTok{124035.2}\NormalTok{  Mc2 WHICEAS   }\DecValTok{1275} \OtherTok{TRUE}
\NormalTok{  SightNo Subgroup SightNoDaily Obs ObsStd Bearing Reticle DistNm Cue Method}
\DecValTok{1}     \DecValTok{090}     \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{  }\DecValTok{20060902}\NormalTok{_}\DecValTok{38} \DecValTok{197}   \OtherTok{TRUE}      \DecValTok{59}     \FloatTok{0.3}   \FloatTok{4.12}   \DecValTok{2}      \DecValTok{4}
\NormalTok{  Photos Birds CalibSchool PhotosAerial Biopsy CourseSchool TurtleSp TurtleGs}
\DecValTok{1}\NormalTok{      N     N        }\OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{         }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{           }\OtherTok{NA}     \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\OtherTok{NA}
\NormalTok{  TurtleJFR TurtleAge TurtleCapt PinnipedSp PinnipedGs BoatType BoatGs}
\DecValTok{1}      \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{       }\ErrorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{         }\OtherTok{NA}     \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{     }\OtherTok{NA}
\NormalTok{  PerpDistKm species best low high  prob mixed   ss_tot  lnsstot ss_percent}
\DecValTok{1}   \FloatTok{6.540392}     \DecValTok{003}    \DecValTok{1} \OtherTok{NaN}   \OtherTok{NA} \OtherTok{FALSE}  \OtherTok{TRUE} \FloatTok{3.478261} \FloatTok{1.246532}        \OtherTok{NaN}
\NormalTok{  n_sp n_obs n_best n_low n_high calibr ss_valid mixed_max spp_max included}
\DecValTok{1}    \DecValTok{2}     \DecValTok{1}      \DecValTok{0}     \DecValTok{1}      \DecValTok{0}   \OtherTok{TRUE}    \OtherTok{FALSE}     \OtherTok{FALSE}    \OperatorTok{<}\OtherTok{NA}\OperatorTok{>}\StringTok{     }\OtherTok{TRUE}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cruzi <-}\StringTok{ }\KeywordTok{filter_cruz}\NormalTok{(cruz, }\DataTypeTok{spp=}\StringTok{'003'}\NormalTok{, }\DataTypeTok{years =} \DecValTok{2006}\NormalTok{)}
\KeywordTok{map_cruz}\NormalTok{(cruzi)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{das}\OperatorTok{$}\NormalTok{das[}\DecValTok{405190}\OperatorTok{:}\DecValTok{405220}\NormalTok{]}
...
\addcontentsline{toc}{subsection}{School sizes}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Format ABUND}
\NormalTok{abund <-}\StringTok{ }
\StringTok{  }\NormalTok{SIGHTS }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{pivot_longer}\NormalTok{(}\DataTypeTok{cols =} \DecValTok{31}\OperatorTok{:}\DecValTok{101}\NormalTok{,}
                      \DataTypeTok{names_to =} \StringTok{'species'}\NormalTok{,}
                      \DataTypeTok{values_to =} \StringTok{'best'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Region =} \KeywordTok{gsub}\NormalTok{(}\StringTok{' '}\NormalTok{,}\StringTok{''}\NormalTok{,Region)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(best }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{,}
         \OperatorTok{!}\StringTok{ }\NormalTok{Region }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'NONE'}\NormalTok{, }\StringTok{'Off-Transect'}\NormalTok{),}
\NormalTok{         EffortSeg }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\DataTypeTok{Cruise =}\NormalTok{ CruzNo, TotSS, LnTotSS, species, best) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Software=}\StringTok{'ABUND9'}\NormalTok{)}

\KeywordTok{nrow}\NormalTok{(abund)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2478}
...
\NormalTok{         included }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{, }
\NormalTok{         EffType }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'S'}\NormalTok{, }\StringTok{'F'}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Cruise, }\DataTypeTok{TotSS =}\NormalTok{ ss_tot, }\DataTypeTok{LnTotSS =}\NormalTok{ lnsstot, species, best) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Software=}\StringTok{'LTabundR'}\NormalTok{)}

\CommentTok{# Combine the datasets}
\NormalTok{ss <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(abund, ltabundr)}

\CommentTok{# Plot the datasets}
\KeywordTok{ggplot}\NormalTok{(ss,}
       \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{best, }
           \DataTypeTok{y=}\KeywordTok{factor}\NormalTok{(Cruise), }
           \DataTypeTok{col=}\NormalTok{Software, }
           \DataTypeTok{pch=}\NormalTok{Software)) }\OperatorTok{+}\StringTok{ }
\StringTok{      }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{position=}\NormalTok{ggstance}\OperatorTok{::}\KeywordTok{position_dodgev}\NormalTok{(}\DataTypeTok{height=}\FloatTok{0.5}\NormalTok{),}
                 \DataTypeTok{alpha=}\NormalTok{.}\DecValTok{6}\NormalTok{) }\OperatorTok{+}
\StringTok{      }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{trans=}\StringTok{'log'}\NormalTok{, }\DataTypeTok{breaks=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{, }\DecValTok{5}\NormalTok{,}\DecValTok{10}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{50}\NormalTok{,}\DecValTok{100}\NormalTok{,}\DecValTok{500}\NormalTok{,}\DecValTok{1000}\NormalTok{,}\DecValTok{2500}\NormalTok{,}\DecValTok{5000}\NormalTok{)) }\OperatorTok{+}
\StringTok{      }\KeywordTok{xlab}\NormalTok{(}\StringTok{'log Estimated School Size'}\NormalTok{) }\OperatorTok{+}
\StringTok{      }\KeywordTok{ylab}\NormalTok{(}\StringTok{'Cruise'}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\CommentTok{# Format ABUND}
\NormalTok{abund <-}\StringTok{ }
\StringTok{  }\NormalTok{EFFORT }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Region =} \KeywordTok{gsub}\NormalTok{(}\StringTok{' '}\NormalTok{,}\StringTok{''}\NormalTok{,Region)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{dt =} \KeywordTok{paste0}\NormalTok{(Yr,}
\NormalTok{                     stringr}\OperatorTok{::}\KeywordTok{str_pad}\NormalTok{(Mo, }\DataTypeTok{width=}\DecValTok{2}\NormalTok{, }\DataTypeTok{pad=}\StringTok{'0'}\NormalTok{, }\DataTypeTok{side=}\StringTok{'left'}\NormalTok{),}
\NormalTok{                     stringr}\OperatorTok{::}\KeywordTok{str_pad}\NormalTok{(Da, }\DataTypeTok{width=}\DecValTok{2}\NormalTok{, }\DataTypeTok{pad=}\StringTok{'0'}\NormalTok{, }\DataTypeTok{side=}\StringTok{'left'}\NormalTok{))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{Region }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'NONE'}\NormalTok{, }\StringTok{'Off-Transect'}\NormalTok{),}
\NormalTok{         EffortSeg }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\DataTypeTok{Cruise =}\NormalTok{ CruzNo, }\DataTypeTok{Date =}\NormalTok{ dt, }\DataTypeTok{km =}\NormalTok{ length) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{software =} \StringTok{'ABUND9'}\NormalTok{)}
  
\CommentTok{# Format LTabundR}
\NormalTok{ltabundr <-}\StringTok{ }
\StringTok{  }\NormalTok{cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{dt =} \KeywordTok{gsub}\NormalTok{(}\StringTok{'-'}\NormalTok{,}\StringTok{''}\NormalTok{,}\KeywordTok{substr}\NormalTok{(DateTime1, }\DecValTok{1}\NormalTok{,}\DecValTok{10}\NormalTok{))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(OnEffort }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{, }
\NormalTok{         use }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{, }
\NormalTok{         EffType }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'S'}\NormalTok{, }\StringTok{'F'}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Cruise, }\DataTypeTok{Date =}\NormalTok{ dt, }\DataTypeTok{km =}\NormalTok{ dist) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{software =} \StringTok{'LTabundR'}\NormalTok{)}
  
\CommentTok{# Join the datasets}
\NormalTok{eff <-}\StringTok{ }
\StringTok{  }\KeywordTok{rbind}\NormalTok{(abund, ltabundr) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Cruise) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{km =} \KeywordTok{round}\NormalTok{(km)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{km_abund =} \KeywordTok{sum}\NormalTok{(km[software }\OperatorTok{==}\StringTok{ 'ABUND9'}\NormalTok{]),}
            \DataTypeTok{km_ltabundr =} \KeywordTok{sum}\NormalTok{(km[software }\OperatorTok{==}\StringTok{ 'LTabundR'}\NormalTok{]))}

\CommentTok{# Plot}
\NormalTok{p <-}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(eff, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ km_abund, }\DataTypeTok{y =}\NormalTok{ km_ltabundr, }\DataTypeTok{col=}\KeywordTok{factor}\NormalTok{(Cruise))) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_abline}\NormalTok{(}\DataTypeTok{slope=}\DecValTok{1}\NormalTok{, }\DataTypeTok{intercept=}\DecValTok{0}\NormalTok{, }\DataTypeTok{lty=}\DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{6}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{'LTabundR'}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{'ABUND9'}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{15000}\NormalTok{, }\DataTypeTok{by=}\DecValTok{2500}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{15000}\NormalTok{, }\DataTypeTok{by=}\DecValTok{2500}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title=}\StringTok{'Systematic effort per cruise'}\NormalTok{, }\DataTypeTok{col=}\StringTok{'Cruise'}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_light}\NormalTok{()}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP}
            ...
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329632}\NormalTok{ data rows}
            \OperatorTok{$}\NormalTok{sightings }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{3934}\NormalTok{ detections}
            \OperatorTok{$}\NormalTok{subgroups }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{237}\NormalTok{ subgroups, }\DecValTok{39}\NormalTok{ sightings, and }\DecValTok{345}\NormalTok{ events}
...
\DecValTok{5}\NormalTok{ Melon}\OperatorTok{-}\NormalTok{headed whale     }\DecValTok{031}\NormalTok{ (WHICEAS) }\FloatTok{402948.7} \DecValTok{2017}       \DecValTok{29} \FloatTok{3040.009}
\DecValTok{6}\NormalTok{ Melon}\OperatorTok{-}\NormalTok{headed whale     }\DecValTok{031}\NormalTok{ (WHICEAS) }\FloatTok{402948.7} \DecValTok{2020}       \DecValTok{34} \FloatTok{4585.386}
...
\DecValTok{3}           \OtherTok{NA}       \OtherTok{NA} \DecValTok{0}  \FloatTok{0.341} \FloatTok{0.0000000000} \FloatTok{0.0000000000}    \FloatTok{0.00000}        \OtherTok{NA}
...
\DecValTok{3}          \OtherTok{NA} \FloatTok{0.00000000} \FloatTok{0.00000000}     \FloatTok{0.000}
...
\includegraphics{figures/unnamed-chunk-238-2.pdf} \includegraphics{figures/unnamed-chunk-238-3.pdf} \includegraphics{figures/unnamed-chunk-238-4.pdf} \includegraphics{figures/unnamed-chunk-238-5.pdf} \includegraphics{figures/unnamed-chunk-238-6.pdf} \includegraphics{figures/unnamed-chunk-238-7.pdf} \includegraphics{figures/unnamed-chunk-238-8.pdf} \includegraphics{figures/unnamed-chunk-238-9.pdf} \includegraphics{figures/unnamed-chunk-238-10.pdf} \includegraphics{figures/unnamed-chunk-238-11.pdf} \includegraphics{figures/unnamed-chunk-238-12.pdf}
...
\DecValTok{3}           \OtherTok{NA}       \OtherTok{NA} \DecValTok{0}  \FloatTok{0.345} \FloatTok{0.0000000000} \FloatTok{0.0000000000}    \FloatTok{0.00000}        \OtherTok{NA}
...
\DecValTok{1}    \DecValTok{11}\NormalTok{           hn }\OperatorTok{~}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{ship }\OperatorTok{+}\StringTok{ }\NormalTok{bft }\OperatorTok{+}\StringTok{ }\NormalTok{lnsstot }\OperatorTok{+}\StringTok{ }\NormalTok{species }\FloatTok{0.5357372} \FloatTok{1041.309}
\DecValTok{2}     \DecValTok{9}\NormalTok{           hn           }\OperatorTok{~}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{ship }\OperatorTok{+}\StringTok{ }\NormalTok{bft }\OperatorTok{+}\StringTok{ }\NormalTok{lnsstot }\FloatTok{0.5431524} \FloatTok{1042.481}
...
\DecValTok{2}        \FloatTok{1.172}\NormalTok{ bft, lnsstot, ship, species Multi}\OperatorTok{-}\NormalTok{species pool }\DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  title   Region year  species itera}\OperatorTok{~}\DecValTok{1}\NormalTok{ ESW_m}\OperatorTok{~}\DecValTok{2}\NormalTok{ g0_mean g0_cv    km     ER      D}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{int}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ Fraser}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{026}          \DecValTok{10}  \OtherTok{NaN}      \FloatTok{0.390} \FloatTok{0.713} \FloatTok{3103.} \DecValTok{0}      \DecValTok{0}     
\DecValTok{2}\NormalTok{ Fraser}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{026}          \DecValTok{10}    \FloatTok{3.52}   \FloatTok{0.390} \FloatTok{0.654} \FloatTok{4689.} \FloatTok{0.0902} \FloatTok{0.0516}
\DecValTok{3}\NormalTok{ Melon}\OperatorTok{-}\ErrorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{031}          \DecValTok{10}    \FloatTok{3.10}   \FloatTok{0.422} \FloatTok{0.275} \FloatTok{3103.} \FloatTok{0.181}  \FloatTok{0.0728}
\DecValTok{4}\NormalTok{ Melon}\OperatorTok{-}\ErrorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{031}          \DecValTok{10}    \FloatTok{3.50}   \FloatTok{0.425} \FloatTok{0.251} \FloatTok{4689.} \FloatTok{0.180}  \FloatTok{0.0703}
\DecValTok{5}\NormalTok{ Stripe}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{013}          \DecValTok{10}    \FloatTok{3.66}   \FloatTok{0.425} \FloatTok{0.148} \FloatTok{3103.} \FloatTok{0.0435} \FloatTok{0.0142}
\DecValTok{6}\NormalTok{ Stripe}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{013}          \DecValTok{10}    \FloatTok{3.69}   \FloatTok{0.367} \FloatTok{0.179} \FloatTok{4689.} \FloatTok{0.0425} \FloatTok{0.0159}
\CommentTok{# ... with 7 more variables: size <dbl>, Nmean <dbl>, Nmedian <dbl>, Nsd <dbl>,}
\CommentTok{#   CV <dbl>, L95 <dbl>, U95 <dbl>, and abbreviated variable names}
\CommentTok{#   1: iterations, 2: ESW_mean}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{1}\NormalTok{ all     HI_EEZ   }\DecValTok{16166} \FloatTok{0.00124} \FloatTok{0.0127} \FloatTok{0.0383} \FloatTok{0.117} \FloatTok{0.480} \FloatTok{0.303} \FloatTok{0.0474}

\OperatorTok{$}\StringTok{`}\DataTypeTok{2017}\StringTok{`}
\CommentTok{# A tibble: 1 x 10}
\NormalTok{  Species Stratum Effort       B0     B1     B2    B3    B4    B5    B6}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ all     HI_EEZ   }\DecValTok{15913} \FloatTok{0.000828} \FloatTok{0.0102} \FloatTok{0.0370} \FloatTok{0.117} \FloatTok{0.312} \FloatTok{0.350} \FloatTok{0.173}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  estimates}
  ...
  \CommentTok{# Manually specify g0 and its CV -- only for g0_scenario 1}
  \CommentTok{# Two specifications per species, one for 2017 and one for 2020}
  \ControlFlowTok{if}\NormalTok{(g0_scenario}\OperatorTok{==}\DecValTok{1}\NormalTok{)\{}
    \CommentTok{# Striped }
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.35}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.19}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.31}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.22}
    \CommentTok{# Fraser's}
\NormalTok{    estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.35}\NormalTok{; estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.10}
\NormalTok{    estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.31}\NormalTok{; estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.22}
    \CommentTok{# Melon-headed}
\NormalTok{    estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.35}\NormalTok{; estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.19}
\NormalTok{    estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.31}\NormalTok{; estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.22}
\NormalTok{  \}}
...
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.09}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.45}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.07}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.51}
    \CommentTok{# Risso's}
\NormalTok{    estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.57}\NormalTok{; estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.18}
\NormalTok{    estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.52}\NormalTok{; estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\DecValTok{021}
    \CommentTok{# Pygmy killer}
\NormalTok{    estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.14}\NormalTok{; estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.25}
\NormalTok{    estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.11}\NormalTok{; estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.28}
\NormalTok{  \}}
...
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.58}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.52}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.19}
    \CommentTok{# Longman's}
\NormalTok{    estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.58}\NormalTok{; estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
\NormalTok{    estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.52}\NormalTok{; estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.19}
\NormalTok{  \}}
...
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\DecValTok{1}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\DecValTok{0}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\DecValTok{1}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\DecValTok{0}
    \CommentTok{# Sperm}
\NormalTok{    estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.63}\NormalTok{; estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.34}
\NormalTok{    estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.61}\NormalTok{; estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.37}
\NormalTok{  \}}
...
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.005}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.004}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
    \CommentTok{# Dwarf sperm (no ALB sightings in 2017, using 2020 g0)}
\NormalTok{    estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.005}\NormalTok{; estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
\NormalTok{    estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.004}\NormalTok{; estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
    \CommentTok{# UNID Kogia (no ALB sightings 2020, using 2017 g0)}
\NormalTok{    estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.005}\NormalTok{; estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
\NormalTok{    estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.004}\NormalTok{; estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.15}
    \CommentTok{# Blainville's (no ALB sightings 2017, using 2020 g0)}
\NormalTok{    estimates[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.11}\NormalTok{; estimates[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.30}
\NormalTok{    estimates[[}\DecValTok{8}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.11}\NormalTok{; estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.30}
    \CommentTok{# Cuvier's (no sightings in ALB -- using unid beaked g0)}
\NormalTok{    estimates[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.13}\NormalTok{; estimates[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.20}
\NormalTok{    estimates[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.11}\NormalTok{; estimates[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
    \CommentTok{# UNID Mesop (no ALB sightings 2017, using 2020 g0)}
\NormalTok{    estimates[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.11}\NormalTok{; estimates[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.30}
\NormalTok{    estimates[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.11}\NormalTok{; estimates[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.30}
    \CommentTok{# UNID beaked}
\NormalTok{    estimates[[}\DecValTok{13}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.13}\NormalTok{; estimates[[}\DecValTok{13}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.20}
\NormalTok{    estimates[[}\DecValTok{14}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.11}\NormalTok{; estimates[[}\DecValTok{14}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
\NormalTok{  \}}
...
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.38}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.38}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
    \CommentTok{# Sei (no ALB sightings in 2017, using 2020 g0)}
\NormalTok{    estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.38}\NormalTok{; estimates[[}\DecValTok{3}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
\NormalTok{    estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.38}\NormalTok{; estimates[[}\DecValTok{4}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
    \CommentTok{# Fin (no ALB sightings in 2017, using 2020 g0)}
\NormalTok{    estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.30}\NormalTok{; estimates[[}\DecValTok{5}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.29}
\NormalTok{    estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.30}\NormalTok{; estimates[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.29}
    \CommentTok{# Blue (no ALB sightings, using fin values)}
\NormalTok{    estimates[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.30}\NormalTok{; estimates[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.29}
\NormalTok{    estimates[[}\DecValTok{8}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.30}\NormalTok{; estimates[[}\DecValTok{8}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.29}
    \CommentTok{# Sei / Bryde's (no ALB sightings in 2017, using 2020 g0)}
\NormalTok{    estimates[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.38}\NormalTok{; estimates[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
\NormalTok{    estimates[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.38}\NormalTok{; estimates[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.21}
    \CommentTok{# Sei / Bryde's / Fin (no ALB sightings in 2017, using 2020 g0)}
\NormalTok{    estimates[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.34}\NormalTok{; estimates[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.17}
\NormalTok{    estimates[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.34}\NormalTok{; estimates[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.17}
\NormalTok{  \}}
...
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.68}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.36}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.68}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.36}
\NormalTok{   \}}
...
\StringTok{      }\KeywordTok{c}\NormalTok{(}\KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =} \StringTok{'070'}\NormalTok{, }
  ...
  \ControlFlowTok{if}\NormalTok{(g0_scenario}\OperatorTok{==}\DecValTok{1}\NormalTok{)\{}
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.35}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.18}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.32}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.20}
\NormalTok{  \}}
...
\NormalTok{  results}\OperatorTok{$}\NormalTok{bootstrap}\OperatorTok{$}\NormalTok{summary }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.data.frame}
...
\NormalTok{  estimates <-}\StringTok{ }\KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =}\NormalTok{ spp, }
                         ...
                         \DataTypeTok{alt_g0_spp =} \KeywordTok{c}\NormalTok{(}\StringTok{'002'}\NormalTok{,}\StringTok{'013'}\NormalTok{,}\StringTok{'018'}\NormalTok{,}\StringTok{'015'}\NormalTok{, }\StringTok{'036'}\NormalTok{, }\StringTok{'021'}\NormalTok{),}
                         \DataTypeTok{combine_g0 =} \OtherTok{TRUE}\NormalTok{)}
  
  \ControlFlowTok{if}\NormalTok{(g0_scenario}\OperatorTok{==}\DecValTok{1}\NormalTok{)\{}
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.33}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.08}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.29}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.10}
\NormalTok{  \}}
...
\NormalTok{  estimates <-}\StringTok{ }\KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =}\NormalTok{ spp, }
  ...
  \ControlFlowTok{if}\NormalTok{(g0_scenario}\OperatorTok{==}\DecValTok{1}\NormalTok{)\{}
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{1.0}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.0}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{1.0}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.0}
\NormalTok{  \}}
...
\NormalTok{  estimates <-}\StringTok{ }\KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =} \StringTok{'018'}\NormalTok{, }\DataTypeTok{title =} \StringTok{'Bottlenose dolphin'}\NormalTok{)}
  ...
  \ControlFlowTok{if}\NormalTok{(g0_scenario}\OperatorTok{==}\DecValTok{1}\NormalTok{)\{}
    \CommentTok{# No ALB sightings in 2017, using 2020 g0}
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.24}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.38}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.24}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.38}
\NormalTok{  \}}
...
\NormalTok{  estimates <-}\StringTok{ }\KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =} \StringTok{'002'}\NormalTok{, }\DataTypeTok{title =} \StringTok{'Pantropical spotted dolphin'}\NormalTok{)}
  ...
  \ControlFlowTok{if}\NormalTok{(g0_scenario}\OperatorTok{==}\DecValTok{1}\NormalTok{)\{}
\NormalTok{    estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.28}\NormalTok{; estimates[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.11}
\NormalTok{    estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0 <-}\StringTok{ }\FloatTok{0.25}\NormalTok{; estimates[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{g0_cv <-}\StringTok{ }\FloatTok{0.13}
\NormalTok{  \}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sample_size <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(cruz, spp, cohort, years, td, }\DataTypeTok{in_region=}\OtherTok{NULL}\NormalTok{, }\DataTypeTok{region_remove =} \OtherTok{NULL}\NormalTok{)\{}
  \KeywordTok{suppressMessages}\NormalTok{(\{}
\NormalTok{    sits <-}\StringTok{ }
\StringTok{    }\NormalTok{cruz}\OperatorTok{$}\NormalTok{cohorts[[cohort]]}\OperatorTok{$}\NormalTok{sightings }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(species }\OperatorTok{%in%}\StringTok{ }\NormalTok{spp) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{%in%}\StringTok{ }\NormalTok{years) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(stratum }\OperatorTok{%in%}\StringTok{ }\NormalTok{in_region) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{stratum }\OperatorTok{%in%}\StringTok{ }\NormalTok{region_remove) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{species =} \KeywordTok{paste}\NormalTok{(spp, }\DataTypeTok{collapse=}\StringTok{'/'}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{group_by}\NormalTok{(species, year) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{ntot =} \KeywordTok{n}\NormalTok{(),}
              \DataTypeTok{nsys =} \KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(use }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE} \OperatorTok{&}\StringTok{ }
\StringTok{                                    }\NormalTok{Bft }\OperatorTok{<=}\StringTok{ }\DecValTok{6} \OperatorTok{&}\StringTok{ }
\StringTok{                                    }\NormalTok{EffType }\OperatorTok{==}\StringTok{ 'S'}\NormalTok{)),}
              \DataTypeTok{nest =} \KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(use }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE} \OperatorTok{&}
\StringTok{                                    }\NormalTok{included }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE} \OperatorTok{&}\StringTok{ }
\StringTok{                                    }\NormalTok{Bft }\OperatorTok{<=}\StringTok{ }\DecValTok{6} \OperatorTok{&}\StringTok{ }
\StringTok{                                    }\NormalTok{EffType }\OperatorTok{==}\StringTok{ 'S'} \OperatorTok{&}\StringTok{ }
\StringTok{                                    }\NormalTok{PerpDistKm }\OperatorTok{<=}\StringTok{ }\NormalTok{td))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{pivot_longer}\NormalTok{(}\DataTypeTok{cols =}\NormalTok{ ntot}\OperatorTok{:}\NormalTok{nest) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{pivot_wider}\NormalTok{(}\DataTypeTok{id_cols =}\NormalTok{ species,}
                \DataTypeTok{names_from =}\NormalTok{ year}\OperatorTok{:}\NormalTok{name,}
                \DataTypeTok{values_from =}\NormalTok{ value)}
\NormalTok{  \})}
  \KeywordTok{return}\NormalTok{(sits)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{source=}\StringTok{'ALB et al. (2022)'}\NormalTok{,}
           ...
           \DataTypeTok{year =} \KeywordTok{ifelse}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(}\StringTok{'17'}\NormalTok{, column), }\DecValTok{2017}\NormalTok{, }\DecValTok{2020}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric) }\OperatorTok{%>%}
...
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{g0 =}\NormalTok{ value[column }\OperatorTok{==}\StringTok{ 'g0'}\NormalTok{][}\DecValTok{1}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{g0_cv =}\NormalTok{ value[column }\OperatorTok{==}\StringTok{ 'gcv'}\NormalTok{][}\DecValTok{1}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{ESW =}\NormalTok{ value[column }\OperatorTok{==}\StringTok{ 'esw'}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{ss =}\NormalTok{ value[column }\OperatorTok{==}\StringTok{ 'ss'}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{D =}\NormalTok{ value[column }\OperatorTok{==}\StringTok{ 'd'}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{N =} \KeywordTok{gsub}\NormalTok{(}\StringTok{','}\NormalTok{,}\StringTok{''}\NormalTok{, value[column }\OperatorTok{==}\StringTok{ 'n'}\NormalTok{]) }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{CV =}\NormalTok{ value[column }\OperatorTok{==}\StringTok{ 'cv'}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{L95 =} \KeywordTok{gsub}\NormalTok{(}\StringTok{','}\NormalTok{,}\StringTok{''}\NormalTok{, value[column }\OperatorTok{==}\StringTok{ 'lci'}\NormalTok{]) }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric,}
              \DataTypeTok{U95 =} \KeywordTok{gsub}\NormalTok{(}\StringTok{','}\NormalTok{,}\StringTok{''}\NormalTok{, value[column }\OperatorTok{==}\StringTok{ 'uci'}\NormalTok{]) }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(D)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{N =} \KeywordTok{round}\NormalTok{(N))}

\CommentTok{# Modify names}
\KeywordTok{names}\NormalTok{(alb)[}\DecValTok{4}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(alb)] <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'alb_'}\NormalTok{,}\KeywordTok{names}\NormalTok{(alb)[}\DecValTok{4}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(alb)] )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{whiceas_join <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(alb, ltas)\{}
  \CommentTok{# Combine core info from each LTA list into a dataframe}
\NormalTok{  ltabundr <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{()}
  \ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(ltas))\{}
\NormalTok{    lti <-}\StringTok{ }\NormalTok{ltas[[i]]}
\NormalTok{    ltabundi <-}
\StringTok{      }\KeywordTok{left_join}\NormalTok{(lti}\OperatorTok{$}\NormalTok{estimate,}
\NormalTok{                lti}\OperatorTok{$}\NormalTok{bootstrap}\OperatorTok{$}\NormalTok{summary }\OperatorTok{%>%}\StringTok{ }
\StringTok{                  }\KeywordTok{select}\NormalTok{(title, Region, year, species, iterations, }
\NormalTok{                         g0_cv, CV, L95, U95),}
                \DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{'title'}\NormalTok{, }\StringTok{'Region'}\NormalTok{, }\StringTok{'year'}\NormalTok{, }\StringTok{'species'}\NormalTok{))}
\NormalTok{    ltabundr <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(ltabundr, ltabundi)}
\NormalTok{  \}}

  \CommentTok{# Format ltabundr data}
\NormalTok{  ltabundr <-}\StringTok{ }\NormalTok{ltabundr }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year =} \KeywordTok{as.numeric}\NormalTok{(year),}
           \DataTypeTok{D =}\NormalTok{ D}\OperatorTok{*}\DecValTok{1000}\NormalTok{,}
           \DataTypeTok{N =} \KeywordTok{round}\NormalTok{(N)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(title, species, year, }\DataTypeTok{g0=}\NormalTok{g0_est, g0_cv, }
           \DataTypeTok{ESW =}\NormalTok{ ESW_mean, }\DataTypeTok{ss =}\NormalTok{ size_mean, D, N, CV, L95, U95)}

  \CommentTok{# Join ALB to LTabundR}
\NormalTok{  mr <-}\StringTok{ }\KeywordTok{left_join}\NormalTok{(ltabundr, alb, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{'title'}\NormalTok{, }\StringTok{'year'}\NormalTok{))}
  \KeywordTok{return}\NormalTok{(mr)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ltas <-}\StringTok{ }\KeywordTok{lta_enlist}\NormalTok{(}\StringTok{'whiceas/lta_manual/'}\NormalTok{)}
\NormalTok{mr1 <-}\StringTok{ }\KeywordTok{whiceas_join}\NormalTok{(alb, ltas) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \StringTok{'ALB et al. (2022)'}\NormalTok{)}

\CommentTok{# Barlow (2015) Rg0}
\NormalTok{ltas <-}\StringTok{ }\KeywordTok{lta_enlist}\NormalTok{(}\StringTok{'whiceas/lta_barlow/'}\NormalTok{)}
\NormalTok{mr2 <-}\StringTok{ }\KeywordTok{whiceas_join}\NormalTok{(alb, ltas) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \StringTok{'Barlow (2015)'}\NormalTok{)}

\CommentTok{# New auto-generated Rg(0)}
\NormalTok{ltas <-}\StringTok{ }\KeywordTok{lta_enlist}\NormalTok{(}\StringTok{'whiceas/lta/'}\NormalTok{)}
\NormalTok{mr3 <-}\StringTok{ }\KeywordTok{whiceas_join}\NormalTok{(alb, ltas) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \StringTok{'LTabundR'}\NormalTok{)}

\CommentTok{# Join them together}
\NormalTok{mr <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(mr1, mr2, mr3) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \KeywordTok{factor}\NormalTok{(scenario, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{'ALB et al. (2022)'}\NormalTok{,}
                                                \StringTok{'Barlow (2015)'}\NormalTok{,}
                                                \StringTok{'LTabundR'}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  estimates <-}\StringTok{ }\KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =}\NormalTok{ spp, }
                         \DataTypeTok{title =}\NormalTok{ pool_title,}
                         \DataTypeTok{alt_g0_spp =} \KeywordTok{c}\NormalTok{(}\StringTok{'002'}\NormalTok{,}\StringTok{'013'}\NormalTok{,}\StringTok{'018'}\NormalTok{,}
                                        \StringTok{'015'}\NormalTok{, }\StringTok{'036'}\NormalTok{, }\StringTok{'021'}\NormalTok{),}
                         \DataTypeTok{combine_g0 =} \OtherTok{TRUE}\NormalTok{)}
...
\CommentTok{# A tibble: 5 x 10}
\NormalTok{  Species    Stratum Effort      B0      B1     B2     B3    B4    B5     B6}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ spotted    MHI       }\DecValTok{2642} \DecValTok{0}       \DecValTok{0}       \FloatTok{0.142}  \FloatTok{0.0865} \FloatTok{0.387} \FloatTok{0.304} \FloatTok{0.0806}
\DecValTok{2}\NormalTok{ bottlenose MHI       }\DecValTok{3431} \DecValTok{0}       \FloatTok{0.00411} \FloatTok{0.123}  \FloatTok{0.0785} \FloatTok{0.389} \FloatTok{0.337} \FloatTok{0.0685}
\DecValTok{3}\NormalTok{ all        MHI       }\DecValTok{3706} \DecValTok{0}       \FloatTok{0.00380} \FloatTok{0.134}  \FloatTok{0.0828} \FloatTok{0.379} \FloatTok{0.334} \FloatTok{0.0667}
\DecValTok{4}\NormalTok{ all        HI_EEZ   }\DecValTok{14523} \FloatTok{0.00805} \FloatTok{0.0146}  \FloatTok{0.0460} \FloatTok{0.0980} \FloatTok{0.492} \FloatTok{0.311} \FloatTok{0.0306}
\DecValTok{5}\NormalTok{ bottlenose HI_EEZ   }\DecValTok{14524} \FloatTok{0.00805} \FloatTok{0.0146}  \FloatTok{0.0459} \FloatTok{0.0979} \FloatTok{0.492} \FloatTok{0.311} \FloatTok{0.0306}

\OperatorTok{$}\StringTok{`}\DataTypeTok{2010}\StringTok{`}
\CommentTok{# A tibble: 4 x 10}
\NormalTok{  Species    Stratum Effort      B0     B1     B2    B3    B4    B5      B6}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ spotted    MHI       }\DecValTok{1508} \DecValTok{0}       \DecValTok{0}      \FloatTok{0.0784} \FloatTok{0.173} \FloatTok{0.419} \FloatTok{0.321} \FloatTok{0.00837}
\DecValTok{2}\NormalTok{ bottlenose MHI       }\DecValTok{1880} \DecValTok{0}       \DecValTok{0}      \FloatTok{0.0785} \FloatTok{0.146} \FloatTok{0.423} \FloatTok{0.340} \FloatTok{0.0128} 
\DecValTok{3}\NormalTok{ all        MHI       }\DecValTok{1930} \DecValTok{0}       \DecValTok{0}      \FloatTok{0.0765} \FloatTok{0.149} \FloatTok{0.419} \FloatTok{0.343} \FloatTok{0.0125} 
\DecValTok{4}\NormalTok{ all        HI_EEZ   }\DecValTok{16092} \FloatTok{0.00124} \FloatTok{0.0128} \FloatTok{0.0385} \FloatTok{0.118} \FloatTok{0.482} \FloatTok{0.300} \FloatTok{0.0476} 

\OperatorTok{$}\StringTok{`}\DataTypeTok{2017}\StringTok{`}
\CommentTok{# A tibble: 4 x 10}
\NormalTok{  Species    Stratum Effort       B0     B1     B2    B3    B4    B5     B6}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ spotted    MHI       }\DecValTok{1107} \DecValTok{0}        \DecValTok{0}      \FloatTok{0.136}  \FloatTok{0.245} \FloatTok{0.340} \FloatTok{0.193} \FloatTok{0.0864}
\DecValTok{2}\NormalTok{ bottlenose MHI       }\DecValTok{1259} \DecValTok{0}        \DecValTok{0}      \FloatTok{0.105}  \FloatTok{0.229} \FloatTok{0.354} \FloatTok{0.243} \FloatTok{0.0700}
\DecValTok{3}\NormalTok{ all        MHI       }\DecValTok{1360} \DecValTok{0}        \DecValTok{0}      \FloatTok{0.111}  \FloatTok{0.213} \FloatTok{0.368} \FloatTok{0.231} \FloatTok{0.0769}
\DecValTok{4}\NormalTok{ all        HI_EEZ   }\DecValTok{15913} \FloatTok{0.000828} \FloatTok{0.0102} \FloatTok{0.0370} \FloatTok{0.117} \FloatTok{0.312} \FloatTok{0.350} \FloatTok{0.173} 
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  Species    Stratum Effort      B0     B1     B2     B3    B4    B5     B6}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ all        HI_EEZ   }\DecValTok{14523} \FloatTok{0.00805} \FloatTok{0.0146} \FloatTok{0.0460} \FloatTok{0.0980} \FloatTok{0.492} \FloatTok{0.311} \FloatTok{0.0306}
\DecValTok{2}\NormalTok{ bottlenose HI_EEZ   }\DecValTok{14524} \FloatTok{0.00805} \FloatTok{0.0146} \FloatTok{0.0459} \FloatTok{0.0979} \FloatTok{0.492} \FloatTok{0.311} \FloatTok{0.0306}

\OperatorTok{$}\StringTok{`}\DataTypeTok{2010}\StringTok{`}
\CommentTok{# A tibble: 1 x 10}
\NormalTok{  Species Stratum Effort      B0     B1     B2    B3    B4    B5     B6}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ all     HI_EEZ   }\DecValTok{16092} \FloatTok{0.00124} \FloatTok{0.0128} \FloatTok{0.0385} \FloatTok{0.118} \FloatTok{0.482} \FloatTok{0.300} \FloatTok{0.0476}
...
\CommentTok{# Number of segments}
\NormalTok{cruz_demo}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{default}\OperatorTok{$}\NormalTok{segments }\OperatorTok{%>%}\StringTok{ }\NormalTok{nrow}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{597}
