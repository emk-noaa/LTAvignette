...
\ErrorTok{$}\StringTok{ }\NormalTok{yday         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{37}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{44}\NormalTok{, }\DecValTok{44}\NormalTok{, }\DecValTok{49}\NormalTok{, }\DecValTok{55}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{41}\NormalTok{, }\DecValTok{43}\NormalTok{, }\DecValTok{46}\NormalTok{, }\DecValTok{47}\NormalTok{, }\DecValTok{48}\NormalTok{, }\DecValTok{37}\NormalTok{, }\DecValTok{3}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{dist         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{149.851072}\NormalTok{, }\FloatTok{149.959115}\NormalTok{, }\FloatTok{3.366761}\NormalTok{, }\FloatTok{150.656675}\NormalTok{, }\FloatTok{149.562750}\NormalTok{,}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{21.99817}\NormalTok{, }\FloatTok{21.14833}\NormalTok{, }\FloatTok{19.17733}\NormalTok{, }\FloatTok{19.19833}\NormalTok{, }\FloatTok{20.40850}\NormalTok{, }\FloatTok{21.7600}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-159.1487}\NormalTok{, }\FloatTok{-158.0103}\NormalTok{, }\FloatTok{-156.0610}\NormalTok{, }\FloatTok{-156.0760}\NormalTok{, }\FloatTok{-156.1288}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{DateTime1    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-06} \DecValTok{07}\OperatorTok{:}\DecValTok{33}\OperatorTok{:}\DecValTok{52}\NormalTok{, }\DecValTok{2009-02-10} \DecValTok{09}\OperatorTok{:}\DecValTok{41}\OperatorTok{:}\DecValTok{09}\NormalTok{, }\DecValTok{2009-02-13} \DecValTok{17}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp1   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1233905632}\NormalTok{, }\DecValTok{1234258869}\NormalTok{, }\DecValTok{1234545197}\NormalTok{, }\DecValTok{1234548006}\NormalTok{, }\DecValTok{123498100}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{21.14850}\NormalTok{, }\FloatTok{19.18117}\NormalTok{, }\FloatTok{19.19783}\NormalTok{, }\FloatTok{20.40850}\NormalTok{, }\FloatTok{21.76150}\NormalTok{, }\FloatTok{21.6810}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-158.0097}\NormalTok{, }\FloatTok{-156.0583}\NormalTok{, }\FloatTok{-156.0758}\NormalTok{, }\FloatTok{-156.1288}\NormalTok{, }\FloatTok{-157.2517}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{DateTime2    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-10} \DecValTok{09}\OperatorTok{:}\DecValTok{40}\OperatorTok{:}\DecValTok{54}\NormalTok{, }\DecValTok{2009-02-13} \DecValTok{17}\OperatorTok{:}\DecValTok{11}\OperatorTok{:}\DecValTok{22}\NormalTok{, }\DecValTok{2009-02-13} \DecValTok{17}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp2   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1234258854}\NormalTok{, }\DecValTok{1234545082}\NormalTok{, }\DecValTok{1234547957}\NormalTok{, }\DecValTok{1234981000}\NormalTok{, }\DecValTok{123549202}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlat         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{19.57617}\NormalTok{, }\FloatTok{21.37917}\NormalTok{, }\FloatTok{19.18500}\NormalTok{, }\FloatTok{19.80333}\NormalTok{, }\FloatTok{22.46000}\NormalTok{, }\FloatTok{21.7095}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlon         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-156.0153}\NormalTok{, }\FloatTok{-160.3327}\NormalTok{, }\FloatTok{-156.0727}\NormalTok{, }\FloatTok{-155.0388}\NormalTok{, }\FloatTok{-160.4300}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mDateTime    }\OperatorTok{<}\NormalTok{dttm}\OperatorTok{>}\StringTok{ }\DecValTok{2009-02-08} \DecValTok{07}\OperatorTok{:}\DecValTok{57}\OperatorTok{:}\DecValTok{43}\NormalTok{, }\DecValTok{2009-02-11} \DecValTok{10}\OperatorTok{:}\DecValTok{36}\OperatorTok{:}\DecValTok{04}\NormalTok{, }\DecValTok{2009-02-13} \DecValTok{17}\OperatorTok{:}\ErrorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mtimestamp   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1233905632}\NormalTok{, }\DecValTok{1234258869}\NormalTok{, }\DecValTok{1234545197}\NormalTok{, }\DecValTok{1234548006}\NormalTok{, }\DecValTok{123498100}\OperatorTok{~}
...
\StringTok{$ day          <int> 6, 10, 13, 13, 18, 24, 6, 6, 10, 12, 15, 16, 17, 6, 7, 7,~}
\StringTok{$ min_line     <int> 424489, 425732, 426950, 426976, 428376, 429786, 424728, 4~}
\StringTok{$ max_line     <int> 425731, 426949, 426975, 428375, 429785, 429845, 424824, 4~}
\StringTok{$ n_rows       <int> 588, 606, 26, 611, 520, 38, 74, 31, 51, 211, 62, 22, 95, ~}
\StringTok{$ avgBft       <dbl> 3.937522, 2.669176, 3.000000, 4.236977, 5.318873, 6.61395~}
\StringTok{$ avgSwellHght <dbl> 3.665611, 2.942091, 4.000000, 4.295680, 5.762063, 7.38604~}
\StringTok{$ avgHorizSun  <dbl> 5.476773, 5.353724, 4.000000, 7.670550, 4.988936, NaN, 4.~}
\StringTok{$ avgVertSun   <dbl> 1.510175, 1.636948, 1.000000, 1.660281, 1.465219, NaN, 1.~}
\StringTok{$ avgGlare     <dbl> 0.01104594, 0.24518732, 0.00000000, 0.11466734, 0.0000000~}
\StringTok{$ avgVis       <dbl> 6.707940, 5.875014, 5.000000, 5.630527, 5.800907, 6.19302~}
\StringTok{$ avgCourse    <dbl> 182.5003, 153.2785, 88.0000, 204.8376, 166.4348, 108.6140~}
\StringTok{$ avgSpdKt     <dbl> 8.296386, 9.165131, 9.900000, 9.395206, 9.292142, 8.62279~}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{1893} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{149.4}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329638}\NormalTok{ data rows}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP, Bottlenose_BI, Bottlenose_OUFI, Bottlenose_KaNi}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{2049} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{148.7}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329638}\NormalTok{ data rows}
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP, Spotted_OU, Spotted_FI, Spotted_BI}
            \OperatorTok{$}\NormalTok{segments  }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{2056} \KeywordTok{segments}\NormalTok{ (}\DataTypeTok{median =} \FloatTok{148.4}\NormalTok{ km)}
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329638}\NormalTok{ data rows}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{3227}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2479}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{3}   \DecValTok{1165} \DecValTok{047}             \OtherTok{NA}         \OtherTok{NA}             \DecValTok{1}             \DecValTok{1}
\DecValTok{4}   \DecValTok{1631} \DecValTok{003}             \OtherTok{NA}         \OtherTok{NA}             \DecValTok{1}             \DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{1}\NormalTok{ CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb_edited.das   }\DecValTok{493027}          \OtherTok{FALSE}             \OtherTok{TRUE}
\NormalTok{  stratum_WHICEAS year month day yday km_int   km_cum ship  stratum seg_id  use}
\DecValTok{1}           \OtherTok{FALSE} \DecValTok{2012}     \DecValTok{5}  \DecValTok{13}  \DecValTok{134}      \DecValTok{0} \FloatTok{171168.7}\NormalTok{  OES OtherCNP    }\DecValTok{277} \OtherTok{TRUE}
...
\NormalTok{                              file_das line_num stratum_HI_EEZ stratum_OtherCNP}
\DecValTok{2}\NormalTok{ CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb_edited.das   }\DecValTok{489960}          \OtherTok{FALSE}             \OtherTok{TRUE}
\NormalTok{  stratum_WHICEAS year month day yday km_int   km_cum ship  stratum seg_id}
\DecValTok{2}           \OtherTok{FALSE} \DecValTok{2012}     \DecValTok{5}   \DecValTok{7}  \DecValTok{128}      \DecValTok{0} \FloatTok{170067.7}\NormalTok{  OES OtherCNP    }\DecValTok{270}
...
\NormalTok{                              file_das line_num stratum_HI_EEZ stratum_OtherCNP}
\DecValTok{1}\NormalTok{ CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb_edited.das    }\DecValTok{50173}          \OtherTok{FALSE}             \OtherTok{TRUE}
\NormalTok{  stratum_WHICEAS year month day yday km_int   km_cum ship  stratum seg_id  use}
\DecValTok{1}           \OtherTok{FALSE} \DecValTok{1988}     \DecValTok{7}  \DecValTok{30}  \DecValTok{212}      \DecValTok{0} \FloatTok{13618.39}\NormalTok{  MAC OtherCNP    }\DecValTok{238} \OtherTok{TRUE}
\NormalTok{  SightNo Subgroup SightNoDaily Obs ObsStd Bearing Reticle DistNm Cue Method}
...
\NormalTok{                              file_das line_num stratum_HI_EEZ stratum_OtherCNP}
\DecValTok{1}\NormalTok{ CenPac1986}\DecValTok{-2020}\NormalTok{_Final_alb_edited.das   }\DecValTok{405222}           \OtherTok{TRUE}             \OtherTok{TRUE}
\NormalTok{  stratum_WHICEAS year month day yday km_int   km_cum ship stratum seg_id  use}
\DecValTok{1}            \OtherTok{TRUE} \DecValTok{2006}     \DecValTok{9}   \DecValTok{2}  \DecValTok{245}      \DecValTok{0} \FloatTok{124035.2}\NormalTok{  Mc2 WHICEAS   }\DecValTok{1277} \OtherTok{TRUE}
\NormalTok{  SightNo Subgroup SightNoDaily Obs ObsStd Bearing Reticle DistNm Cue Method}
...
It appears that this was a multi-species sighting, but percentages were only provided for one species and the overall school size was quite low. Currently we are not sure why \texttt{ABUND} ignored this sighting.
...
\NormalTok{            geostrata}\OperatorTok{:}\StringTok{ }\NormalTok{WHICEAS, HI_EEZ, OtherCNP}
            ...
            \OperatorTok{$}\NormalTok{das       }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{329638}\NormalTok{ data rows}
            \OperatorTok{$}\NormalTok{sightings }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{3934}\NormalTok{ detections}
            \OperatorTok{$}\NormalTok{subgroups }\OperatorTok{---}\StringTok{ }\NormalTok{with }\DecValTok{237}\NormalTok{ subgroups, }\DecValTok{38}\NormalTok{ sightings, and }\DecValTok{345}\NormalTok{ events}
...
\DecValTok{1}    \FloatTok{11003.442} \FloatTok{3.619543} \DecValTok{3}  \FloatTok{0.510} \FloatTok{0.0009868393} \FloatTok{0.0002691926}  \FloatTok{108.47080}  \FloatTok{31.95079}
\DecValTok{2}    \FloatTok{16960.781} \FloatTok{3.698878} \DecValTok{3}  \FloatTok{0.483} \FloatTok{0.0006542525} \FloatTok{0.0001844374}   \FloatTok{74.31882}  \FloatTok{53.95865}
\DecValTok{3}           \OtherTok{NA}       \OtherTok{NA} \DecValTok{0}  \FloatTok{0.443} \FloatTok{0.0000000000} \FloatTok{0.0000000000}    \FloatTok{0.00000}        \OtherTok{NA}
\DecValTok{4}    \FloatTok{16897.976} \FloatTok{3.685181} \DecValTok{2}  \FloatTok{0.413} \FloatTok{0.0004361683} \FloatTok{0.0001437420}   \FloatTok{57.92064} \FloatTok{132.51143}
\DecValTok{5}     \FloatTok{9538.118} \FloatTok{3.137530} \DecValTok{2}  \FloatTok{0.580} \FloatTok{0.0006578929} \FloatTok{0.0001819372}   \FloatTok{73.31137} \FloatTok{185.98103}
\DecValTok{6}    \FloatTok{15957.100} \FloatTok{3.479991} \DecValTok{3}  \FloatTok{0.556} \FloatTok{0.0006542525} \FloatTok{0.0001706628}   \FloatTok{68.76837} \FloatTok{226.13289}
\NormalTok{      size_sd         ER           D         N}
\DecValTok{1}   \FloatTok{0.5780968} \FloatTok{0.03153029} \FloatTok{0.008611828}  \FloatTok{3470.125}
\DecValTok{2}   \FloatTok{2.7402089} \FloatTok{0.03530258} \FloatTok{0.009945862}  \FloatTok{4007.673}
\DecValTok{3}          \OtherTok{NA} \FloatTok{0.00000000} \FloatTok{0.000000000}     \FloatTok{0.000}
\DecValTok{4} \FloatTok{182.1747087} \FloatTok{0.05779729} \FloatTok{0.018008943}  \FloatTok{7256.681}
\DecValTok{5}  \FloatTok{96.4369707} \FloatTok{0.12235559} \FloatTok{0.032840131} \FloatTok{13232.889}
\DecValTok{6} \FloatTok{175.5620746} \FloatTok{0.14794801} \FloatTok{0.040204435} \FloatTok{16200.326}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-236-2.pdf} \includegraphics{figures/unnamed-chunk-236-3.pdf} \includegraphics{figures/unnamed-chunk-236-4.pdf} \includegraphics{figures/unnamed-chunk-236-5.pdf} \includegraphics{figures/unnamed-chunk-236-6.pdf} \includegraphics{figures/unnamed-chunk-236-7.pdf} \includegraphics{figures/unnamed-chunk-236-8.pdf} \includegraphics{figures/unnamed-chunk-236-9.pdf} \includegraphics{figures/unnamed-chunk-236-10.pdf} \includegraphics{figures/unnamed-chunk-236-11.pdf} \includegraphics{figures/unnamed-chunk-236-12.pdf}
...
\DecValTok{6}\NormalTok{ Melon}\OperatorTok{-}\NormalTok{headed whale     }\DecValTok{031}\NormalTok{ (WHICEAS) }\FloatTok{402948.7} \DecValTok{2020}       \DecValTok{34} \FloatTok{4585.386}
\NormalTok{  Area_covered ESW_mean n g0_est  ER_clusters   D_clusters N_clusters size_mean}
\DecValTok{1}    \FloatTok{11003.442} \FloatTok{3.619543} \DecValTok{3}  \FloatTok{0.512} \FloatTok{0.0009868393} \FloatTok{0.0002681410}  \FloatTok{108.04709}  \FloatTok{31.95079}
\DecValTok{2}    \FloatTok{16960.781} \FloatTok{3.698878} \DecValTok{3}  \FloatTok{0.485} \FloatTok{0.0006542525} \FloatTok{0.0001836769}   \FloatTok{74.01235}  \FloatTok{53.95865}
\DecValTok{3}           \OtherTok{NA}       \OtherTok{NA} \DecValTok{0}  \FloatTok{0.446} \FloatTok{0.0000000000} \FloatTok{0.0000000000}    \FloatTok{0.00000}        \OtherTok{NA}
\DecValTok{4}    \FloatTok{16897.976} \FloatTok{3.685181} \DecValTok{2}  \FloatTok{0.410} \FloatTok{0.0004361683} \FloatTok{0.0001447937}   \FloatTok{58.34445} \FloatTok{132.51143}
\DecValTok{5}     \FloatTok{9538.118} \FloatTok{3.137530} \DecValTok{2}  \FloatTok{0.583} \FloatTok{0.0006578929} \FloatTok{0.0001810010}   \FloatTok{72.93413} \FloatTok{185.98103}
\DecValTok{6}    \FloatTok{15957.100} \FloatTok{3.479991} \DecValTok{3}  \FloatTok{0.557} \FloatTok{0.0006542525} \FloatTok{0.0001703564}   \FloatTok{68.64490} \FloatTok{226.13289}
\NormalTok{      size_sd         ER           D         N}
\DecValTok{1}   \FloatTok{0.5780968} \FloatTok{0.03153029} \FloatTok{0.008578188}  \FloatTok{3456.570}
\DecValTok{2}   \FloatTok{2.7402089} \FloatTok{0.03530258} \FloatTok{0.009904849}  \FloatTok{3991.146}
\DecValTok{3}          \OtherTok{NA} \FloatTok{0.00000000} \FloatTok{0.000000000}     \FloatTok{0.000}
\DecValTok{4} \FloatTok{182.1747087} \FloatTok{0.05779729} \FloatTok{0.018140716}  \FloatTok{7309.778}
\DecValTok{5}  \FloatTok{96.4369707} \FloatTok{0.12235559} \FloatTok{0.032671143} \FloatTok{13164.796}
\DecValTok{6} \FloatTok{175.5620746} \FloatTok{0.14794801} \FloatTok{0.040132254} \FloatTok{16171.241}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{1}\NormalTok{ Fraser}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{026}          \DecValTok{10}  \OtherTok{NaN}      \FloatTok{0.454} \FloatTok{0.777} \FloatTok{3030.} \DecValTok{0}      \DecValTok{0}     
\DecValTok{2}\NormalTok{ Fraser}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{026}          \DecValTok{10}    \FloatTok{3.44}   \FloatTok{0.482} \FloatTok{0.763} \FloatTok{4427.} \FloatTok{0.0615} \FloatTok{0.0834}
\DecValTok{3}\NormalTok{ Melon}\OperatorTok{-}\ErrorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{031}          \DecValTok{10}    \FloatTok{3.02}   \FloatTok{0.628} \FloatTok{0.409} \FloatTok{3030.} \FloatTok{0.144}  \FloatTok{0.0707}
\DecValTok{4}\NormalTok{ Melon}\OperatorTok{-}\ErrorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{031}          \DecValTok{10}    \FloatTok{3.26}   \FloatTok{0.633} \FloatTok{0.417} \FloatTok{4427.} \FloatTok{0.205}  \FloatTok{0.0524}
\DecValTok{5}\NormalTok{ Stripe}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2017}  \DecValTok{013}          \DecValTok{10}    \FloatTok{3.49}   \FloatTok{0.479} \FloatTok{0.144} \FloatTok{3030.} \FloatTok{0.0406} \FloatTok{0.0125}
\DecValTok{6}\NormalTok{ Stripe}\OperatorTok{~}\StringTok{ }\NormalTok{(WHIC}\OperatorTok{~}\StringTok{ }\DecValTok{2020}  \DecValTok{013}          \DecValTok{10}    \FloatTok{3.37}   \FloatTok{0.499} \FloatTok{0.184} \FloatTok{4427.} \FloatTok{0.0502} \FloatTok{0.0130}
...
\DecValTok{6}     \DecValTok{073}     \DecValTok{033}\NormalTok{      E    }\DecValTok{89} \FloatTok{2.9817023}   \DecValTok{1609} \FloatTok{2.9812482}   \FloatTok{1.00}   \DecValTok{2} \FloatTok{1.00}
...
\KeywordTok{data}\NormalTok{(ships)}
\KeywordTok{data}\NormalTok{(group_size_coefficients)}
\KeywordTok{data}\NormalTok{(cnp_}\DecValTok{1986}\NormalTok{_}\DecValTok{2020}\NormalTok{_edits)}
...
\StringTok{  }\KeywordTok{process_surveys}\NormalTok{(}\DataTypeTok{das_file =} \StringTok{'data/surveys/CenPac1986-2020_Final_alb.das'}\NormalTok{,}
                  ...
                  \DataTypeTok{edits =}\NormalTok{ cnp_}\DecValTok{1986}\NormalTok{_}\DecValTok{2020}\NormalTok{_edits) }
...
\NormalTok{g0_scenario <-}\StringTok{ }\DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mr1 <-}\StringTok{ }\KeywordTok{whiceas_join}\NormalTok{(alb, ltas) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \StringTok{'Manual g(0)'}\NormalTok{)}
...
\NormalTok{mr2 <-}\StringTok{ }\KeywordTok{whiceas_join}\NormalTok{(alb, ltas) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \StringTok{'Barlow (2015) Rg(0)'}\NormalTok{)}

\CommentTok{# New auto-generated Rg(0)}
\NormalTok{ltas <-}\StringTok{ }\KeywordTok{lta_enlist}\NormalTok{(}\StringTok{'whiceas/lta/'}\NormalTok{)}
\NormalTok{mr3 <-}\StringTok{ }\KeywordTok{whiceas_join}\NormalTok{(alb, ltas) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \StringTok{'New Rg(0) estimates'}\NormalTok{)}

\CommentTok{# Join them together}
\NormalTok{mr <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(mr1, mr2, mr3) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{scenario =} \KeywordTok{factor}\NormalTok{(scenario, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{'Manual g(0)'}\NormalTok{,}
                                                \StringTok{'Barlow (2015) Rg(0)'}\NormalTok{,}
                                                \StringTok{'New Rg(0) estimates'}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{4}\NormalTok{ all        HI_EEZ   }\DecValTok{15393} \FloatTok{0.00828} \FloatTok{0.0196}  \FloatTok{0.0487} \FloatTok{0.0930} \FloatTok{0.487} \FloatTok{0.314} \FloatTok{0.0289}
\DecValTok{5}\NormalTok{ bottlenose HI_EEZ   }\DecValTok{15395} \FloatTok{0.00828} \FloatTok{0.0196}  \FloatTok{0.0487} \FloatTok{0.0930} \FloatTok{0.487} \FloatTok{0.314} \FloatTok{0.0289}
...
\NormalTok{  Species    Stratum Effort      B0     B1     B2     B3    B4    B5     B6}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{      }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ all        HI_EEZ   }\DecValTok{15393} \FloatTok{0.00828} \FloatTok{0.0196} \FloatTok{0.0487} \FloatTok{0.0930} \FloatTok{0.487} \FloatTok{0.314} \FloatTok{0.0289}
\DecValTok{2}\NormalTok{ bottlenose HI_EEZ   }\DecValTok{15395} \FloatTok{0.00828} \FloatTok{0.0196} \FloatTok{0.0487} \FloatTok{0.0930} \FloatTok{0.487} \FloatTok{0.314} \FloatTok{0.0289}
...
\includegraphics{figures/unnamed-chunk-449-1.pdf}
...
\includegraphics{figures/unnamed-chunk-451-1.pdf}
...
\CommentTok{# Number of segments}
\NormalTok{cruz_demo}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{default}\OperatorTok{$}\NormalTok{segments }\OperatorTok{%>%}\StringTok{ }\NormalTok{nrow}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1817}
...
\includegraphics{figures/unnamed-chunk-453-1.pdf}
