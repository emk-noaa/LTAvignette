...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ lta_result }\OperatorTok{%>%}\StringTok{ }\NormalTok{names}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'ltas_2a'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ lta_result }\OperatorTok{%>%}\StringTok{ }\NormalTok{names}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'ltas_2b'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"table1a"} \StringTok{"table1b"} \StringTok{"table2"}  \StringTok{"table3"}  \StringTok{"table4"} 
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{subsubsection}{Table 1 in reports: Sample sizes}

\hypertarget{table-1a}{%
\paragraph{Table 1a}\label{table-1a}}
\addcontentsline{toc}{paragraph}{Table 1a}
...
\addcontentsline{toc}{paragraph}{Table 1b}
...
\addcontentsline{toc}{subsubsection}{Table 2 in reports: Detection functions}
...
\NormalTok{estimates <-}
\StringTok{  }\KeywordTok{c}\NormalTok{(}\KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =} \StringTok{'013'}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Striped dolphin"}\NormalTok{),}
    \KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =} \StringTok{'026'}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Fraser's dolphin"}\NormalTok{),}
    \KeywordTok{estimator}\NormalTok{(}\DataTypeTok{spp =} \StringTok{'031'}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Melon-headed whale"}\NormalTok{))}

\NormalTok{estimates  }
\NormalTok{[[}\DecValTok{1}\NormalTok{]]}
\NormalTok{[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{years}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2002}

\NormalTok{[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"MHI"}
...
\NormalTok{[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"HI_EEZ"}

\NormalTok{[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions_remove}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"MHI"}

\NormalTok{[[}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{region_title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Pelagic HI_EEZ"}
...
\NormalTok{[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions_remove}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"MHI"}

\NormalTok{[[}\DecValTok{6}\NormalTok{]]}\OperatorTok{$}\NormalTok{region_title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Pelagic HI_EEZ"}
...
\NormalTok{[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{years}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2010}

\NormalTok{[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"HI_EEZ"}

\NormalTok{[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{spp}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"026"}

\NormalTok{[[}\DecValTok{7}\NormalTok{]]}\OperatorTok{$}\NormalTok{title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Fraser's dolphin"}


\NormalTok{[[}\DecValTok{8}\NormalTok{]]}
\NormalTok{[[}\DecValTok{8}\NormalTok{]]}\OperatorTok{$}\NormalTok{years}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2017}

\NormalTok{[[}\DecValTok{8}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"HI_EEZ"}

\NormalTok{[[}\DecValTok{8}\NormalTok{]]}\OperatorTok{$}\NormalTok{spp}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"026"}

\NormalTok{[[}\DecValTok{8}\NormalTok{]]}\OperatorTok{$}\NormalTok{title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Fraser's dolphin"}


\NormalTok{[[}\DecValTok{9}\NormalTok{]]}
\NormalTok{[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{years}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2002}

\NormalTok{[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"MHI"}

\NormalTok{[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{spp}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"031"}

\NormalTok{[[}\DecValTok{9}\NormalTok{]]}\OperatorTok{$}\NormalTok{title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Melon-headed whale"}


\NormalTok{[[}\DecValTok{10}\NormalTok{]]}
\NormalTok{[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{years}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2002}

\NormalTok{[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"HI_EEZ"}

\NormalTok{[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions_remove}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"MHI"}

\NormalTok{[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{region_title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Pelagic HI_EEZ"}

\NormalTok{[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{spp}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"031"}

\NormalTok{[[}\DecValTok{10}\NormalTok{]]}\OperatorTok{$}\NormalTok{title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Melon-headed whale"}


\NormalTok{[[}\DecValTok{11}\NormalTok{]]}
\NormalTok{[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{years}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2010}

\NormalTok{[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"HI_EEZ"}

\NormalTok{[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{spp}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"031"}

\NormalTok{[[}\DecValTok{11}\NormalTok{]]}\OperatorTok{$}\NormalTok{title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Melon-headed whale"}


\NormalTok{[[}\DecValTok{12}\NormalTok{]]}
\NormalTok{[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{years}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{2017}

\NormalTok{[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{regions}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"HI_EEZ"}

\NormalTok{[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{spp}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"031"}

\NormalTok{[[}\DecValTok{12}\NormalTok{]]}\OperatorTok{$}\NormalTok{title}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Melon-headed whale"}
\end{Highlighting}
\end{Shaded}
...
\ControlFlowTok{if}\NormalTok{(}\OtherTok{FALSE}\NormalTok{)\{ }\CommentTok{# toggle}
