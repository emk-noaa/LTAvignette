...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{UseMethod}\NormalTok{(}\StringTok{"filter"}\NormalTok{)}\OperatorTok{:}\StringTok{ }\NormalTok{no applicable method }\ControlFlowTok{for} \StringTok{'filter'}\NormalTok{ applied to an object of class }\StringTok{"NULL"}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{appendix-table-1-study-areas}{%
\subsubsection*{Appendix Table 1: Study areas}\label{appendix-table-1-study-areas}}
\addcontentsline{toc}{subsubsection}{Appendix Table 1: Study areas}

\hypertarget{appendix-table-2-effort-totals-parsed-by-beaufort-sea-state}{%
\subsubsection*{Appendix Table 2: Effort totals (parsed by Beaufort sea state)}\label{appendix-table-2-effort-totals-parsed-by-beaufort-sea-state}}
\addcontentsline{toc}{subsubsection}{Appendix Table 2: Effort totals (parsed by Beaufort sea state)}
