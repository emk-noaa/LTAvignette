...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lta_result}\OperatorTok{$}\NormalTok{estimate}
\NormalTok{               title species Region    Area year segments       km Area_covered}
\DecValTok{1}\NormalTok{    Striped dolphin     }\DecValTok{013}\NormalTok{ HI}\OperatorTok{-}\NormalTok{EEZ }\DecValTok{2454639} \DecValTok{2010}      \DecValTok{142} \FloatTok{17957.44}     \FloatTok{62800.60}
\DecValTok{2}\NormalTok{    Striped dolphin     }\DecValTok{013}\NormalTok{ HI}\OperatorTok{-}\NormalTok{EEZ }\DecValTok{2454639} \DecValTok{2017}      \DecValTok{140} \FloatTok{17260.92}     \FloatTok{69221.41}
\DecValTok{3}\NormalTok{    Frasers dolphin     }\DecValTok{026}\NormalTok{ HI}\OperatorTok{-}\NormalTok{EEZ }\DecValTok{2454639} \DecValTok{2010}      \DecValTok{142} \FloatTok{17957.44}     \FloatTok{64201.13}
\DecValTok{4}\NormalTok{    Frasers dolphin     }\DecValTok{026}\NormalTok{ HI}\OperatorTok{-}\NormalTok{EEZ }\DecValTok{2454639} \DecValTok{2017}      \DecValTok{140} \FloatTok{17260.92}     \FloatTok{52088.13}
\DecValTok{5}\NormalTok{ Melon}\OperatorTok{-}\NormalTok{headed whale     }\DecValTok{026}\NormalTok{ HI}\OperatorTok{-}\NormalTok{EEZ }\DecValTok{2454639} \DecValTok{2010}      \DecValTok{142} \FloatTok{17957.44}     \FloatTok{64201.13}
\DecValTok{6}\NormalTok{ Melon}\OperatorTok{-}\NormalTok{headed whale     }\DecValTok{026}\NormalTok{ HI}\OperatorTok{-}\NormalTok{EEZ }\DecValTok{2454639} \DecValTok{2017}      \DecValTok{140} \FloatTok{17260.92}     \FloatTok{52088.13}
\NormalTok{  ESW_mean  n g0_est  ER_clusters    D_clusters N_clusters size_mean   size_sd}
\DecValTok{1} \FloatTok{3.497191} \DecValTok{19}   \FloatTok{0.33} \FloatTok{0.0010580573} \FloatTok{0.00047091315}  \FloatTok{1155.9220}  \FloatTok{51.37295}  \FloatTok{47.24913}
\DecValTok{2} \FloatTok{4.010296} \DecValTok{16}   \FloatTok{0.32} \FloatTok{0.0009269493} \FloatTok{0.00037062119}   \FloatTok{909.7414}  \FloatTok{36.85783}  \FloatTok{17.52562}
\DecValTok{3} \FloatTok{3.575183}  \DecValTok{3}   \FloatTok{0.33} \FloatTok{0.0001670617} \FloatTok{0.00007110128}   \FloatTok{174.5280} \FloatTok{236.20106} \FloatTok{128.98893}
\DecValTok{4} \FloatTok{3.017691}  \DecValTok{2}   \FloatTok{0.32} \FloatTok{0.0001158687} \FloatTok{0.00006035535}   \FloatTok{148.1506} \FloatTok{355.63200}  \FloatTok{91.38621}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lta_result}\OperatorTok{$}\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{names}
...
\NormalTok{lta_result}\OperatorTok{$}\NormalTok{df}\OperatorTok{$}\NormalTok{best_models}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lta_result}\OperatorTok{$}\NormalTok{bootstrap }\OperatorTok{%>%}\StringTok{ }\NormalTok{names}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lta_result}\OperatorTok{$}\NormalTok{bootstrap}\OperatorTok{$}\NormalTok{summary}
\end{Highlighting}
\end{Shaded}
...
\addcontentsline{toc}{section}{Setup your \emph{GoogleSheet}}
...
\addcontentsline{toc}{section}{Run it}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data}\NormalTok{(}\StringTok{"cnp_1986_2020_10km"}\NormalTok{)}
\KeywordTok{data}\NormalTok{(}\StringTok{"ccs_1986_2020_10km"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cnp <-}\StringTok{ }\NormalTok{cnp_}\DecValTok{1986}\NormalTok{_}\DecValTok{2020}\NormalTok{_10km}
\NormalTok{cnp}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments}\OperatorTok{$}\NormalTok{seg_id <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'cnp_'}\NormalTok{, cnp}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments}\OperatorTok{$}\NormalTok{seg_id)}
\NormalTok{cnp}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings}\OperatorTok{$}\NormalTok{seg_id <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'cnp_'}\NormalTok{, cnp}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings}\OperatorTok{$}\NormalTok{seg_id)}
\NormalTok{cnp}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{seg_id <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'cnp_'}\NormalTok{, cnp}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{seg_id)}

\NormalTok{ccs <-}\StringTok{ }\NormalTok{ccs_}\DecValTok{1986}\NormalTok{_}\DecValTok{2020}\NormalTok{_10km}
\NormalTok{ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments}\OperatorTok{$}\NormalTok{seg_id <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'ccs_'}\NormalTok{, ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments}\OperatorTok{$}\NormalTok{seg_id)}
\NormalTok{ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings}\OperatorTok{$}\NormalTok{seg_id <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'ccs_'}\NormalTok{, ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings}\OperatorTok{$}\NormalTok{seg_id)}
\NormalTok{ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{seg_id <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{'ccs_'}\NormalTok{, ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{das}\OperatorTok{$}\NormalTok{seg_id)}

\CommentTok{# Combine}
\NormalTok{cruz <-}\StringTok{ }\NormalTok{cnp}
\NormalTok{cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments,}
\NormalTok{                                   ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{segments)}
\NormalTok{cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings,}
\NormalTok{                                    ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{sightings)}
\NormalTok{cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{das <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{das,}
\NormalTok{                              ccs}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{all}\OperatorTok{$}\NormalTok{das)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Load species settings }
\NormalTok{url <-}\StringTok{ 'https://docs.google.com/spreadsheets/d/1mzyGb2qMUkpXb2ChglVMx9ZXRaGpjq0C2-Xzlj6uYvg/edit?usp=sharing'}
\NormalTok{(df <-}\StringTok{ }\KeywordTok{gsheet2tbl}\NormalTok{(url) }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.data.frame)}

\CommentTok{# Loop through each species}
\NormalTok{result <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{()}
\NormalTok{i=}\DecValTok{24}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(df))\{}

\NormalTok{  (spp_title <-}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{title[i])}
\NormalTok{  (sppi <-}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{species[i])}
\NormalTok{  (sppi <-}\StringTok{ }\KeywordTok{str_split}\NormalTok{(sppi,}\StringTok{','}\NormalTok{)[[}\DecValTok{1}\NormalTok{]])}
\NormalTok{  (sppi <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{' '}\NormalTok{,}\StringTok{''}\NormalTok{,sppi))}
\NormalTok{  (sppi <-}\StringTok{ }\KeywordTok{str_pad}\NormalTok{(sppi, }\DataTypeTok{width=}\DecValTok{3}\NormalTok{, }\DataTypeTok{side=}\StringTok{'left'}\NormalTok{, }\DataTypeTok{pad=}\StringTok{'0'}\NormalTok{))}

\NormalTok{  (tdi <-}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{truncation[i] }\OperatorTok{%>%}\StringTok{ }\NormalTok{as.numeric)}

\NormalTok{  (pooli <-}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{pooling[i])}
  \ControlFlowTok{if}\NormalTok{(pooli }\OperatorTok{==}\StringTok{ '1'}\NormalTok{)\{pooli <-}\StringTok{ '01'}\NormalTok{\}}
  \ControlFlowTok{if}\NormalTok{(pooli }\OperatorTok{==}\StringTok{ '12'}\NormalTok{)\{pooli <-}\StringTok{ '012'}\NormalTok{\}}
  \ControlFlowTok{if}\NormalTok{(pooli }\OperatorTok{==}\StringTok{ 'none'}\NormalTok{)\{pooli <-}\StringTok{ }\OtherTok{NULL}\NormalTok{\}}
\NormalTok{  pooli}

  \CommentTok{# Carry out Rg0 estimation}
\NormalTok{  rg0_sp  <-}\StringTok{ }\KeywordTok{g0_bft_model}\NormalTok{(}\DataTypeTok{spp =}\NormalTok{ sppi,}
                          \DataTypeTok{truncation_distance =}\NormalTok{ tdi,}
                          \DataTypeTok{cruz =}\NormalTok{ cruz,}
                          \DataTypeTok{pool_bft =}\NormalTok{ pooli,}
                          \CommentTok{#jacknife_fraction = NULL)}
                          \DataTypeTok{jacknife_fraction =} \FloatTok{.1}\NormalTok{)}

  \CommentTok{# Summarize sample sizes}
\NormalTok{  (summi <-}\StringTok{ }\NormalTok{rg0_sp}\OperatorTok{$}\NormalTok{summary)}

  \CommentTok{# Review}
\NormalTok{  resulti <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{title =}\NormalTok{ spp_title, }\DataTypeTok{spp =} \KeywordTok{paste}\NormalTok{(sppi, }\DataTypeTok{collapse=}\StringTok{'-'}\NormalTok{), summi)}
\NormalTok{  resulti}

  \CommentTok{# Update results}
\NormalTok{  result <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(result, resulti)}
  \KeywordTok{saveRDS}\NormalTok{(result, }\DataTypeTok{file=}\StringTok{'g0_results.RData'}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

This code (which takes about 8 hours to run on my machine) produces results that we can plot easily.
First we load the result of this analysis, which is provided as a built-in dataset in \texttt{LTabundR}:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data}\NormalTok{(}\StringTok{'g0_result'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{titles <-}\StringTok{ }\NormalTok{g0_result}\OperatorTok{$}\NormalTok{title }\OperatorTok{%>%}\StringTok{ }\NormalTok{unique}
\NormalTok{g0_result}\OperatorTok{$}\NormalTok{Group <-}\StringTok{ }\DecValTok{3}
\NormalTok{g0_result}\OperatorTok{$}\NormalTok{Group[g0_result}\OperatorTok{$}\NormalTok{title }\OperatorTok{%in%}\StringTok{ }\NormalTok{titles[}\KeywordTok{c}\NormalTok{(}\DecValTok{14}\OperatorTok{:}\DecValTok{19}\NormalTok{)]] <-}\StringTok{ }\DecValTok{2}
\NormalTok{g0_result}\OperatorTok{$}\NormalTok{Group[g0_result}\OperatorTok{$}\NormalTok{title }\OperatorTok{%in%}\StringTok{ }\NormalTok{titles[}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{9}\NormalTok{)]] <-}\StringTok{ }\DecValTok{1}
\end{Highlighting}
\end{Shaded}

Relative g(0) for dolphins \ldots{}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(g0_result }\OperatorTok{%>%}
\StringTok{         }\KeywordTok{filter}\NormalTok{(Group }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}
\StringTok{         }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Species =}\NormalTok{ title), }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{bft, }\DataTypeTok{y=}\NormalTok{Rg0, }\DataTypeTok{color=}\NormalTok{Species)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size=}\NormalTok{.}\DecValTok{5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_light}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\DecValTok{0}\OperatorTok{:}\DecValTok{6}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{'Beaufort Sea State'}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{'Relative g(0)'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{figures/unnamed-chunk-123-1.pdf}

\ldots{} for cryptic species \ldots{}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summarize_bft}\NormalTok{(cruz)}\OperatorTok{$}\NormalTok{overall}
...
\DecValTok{1}     \DecValTok{1}   \FloatTok{60.1} \FloatTok{0.0112}
\DecValTok{2}     \DecValTok{2}  \FloatTok{212.}  \FloatTok{0.0397}
\DecValTok{3}     \DecValTok{3}  \FloatTok{507.}  \FloatTok{0.0949}
\DecValTok{4}     \DecValTok{4} \FloatTok{1475.}  \FloatTok{0.276} 
\DecValTok{5}     \DecValTok{5} \FloatTok{2079.}  \FloatTok{0.389} 
\DecValTok{6}     \DecValTok{6} \FloatTok{1012.}  \FloatTok{0.189} 
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{striped_dolphin <-}\StringTok{ }\NormalTok{g0_result }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(spp }\OperatorTok{==}\StringTok{ '013'}\NormalTok{)}

\NormalTok{(Rg0 <-}\StringTok{ }\NormalTok{striped_dolphin}\OperatorTok{$}\NormalTok{Rg0)}
        \DecValTok{1}         \DecValTok{2}         \DecValTok{3}         \DecValTok{4}         \DecValTok{5}         \DecValTok{6}         \DecValTok{7} 
\FloatTok{1.0000000} \FloatTok{0.7010900} \FloatTok{0.4915271} \FloatTok{0.3446048} \FloatTok{0.2415989} \FloatTok{0.1693826} \FloatTok{0.1187524} 

\NormalTok{(Rg0_cv <-}\StringTok{ }\NormalTok{striped_dolphin}\OperatorTok{$}\NormalTok{Rg0_CV)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.00000000} \FloatTok{0.02182160} \FloatTok{0.04375231} \FloatTok{0.06579562} \FloatTok{0.08795508} \FloatTok{0.11023424} \FloatTok{0.13263672}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-133-1.pdf} \includegraphics{figures/unnamed-chunk-133-2.pdf} \includegraphics{figures/unnamed-chunk-133-3.pdf}
...
\includegraphics{figures/unnamed-chunk-136-1.pdf} \includegraphics{figures/unnamed-chunk-136-2.pdf} \includegraphics{figures/unnamed-chunk-136-3.pdf} \includegraphics{figures/unnamed-chunk-136-4.pdf} \includegraphics{figures/unnamed-chunk-136-5.pdf}
