...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{process_surveys}\NormalTok{(}\DataTypeTok{das_file =} \StringTok{'data/surveys/HICEASwinter2020.das'}\NormalTok{,}
...
\NormalTok{Error}\OperatorTok{:}\StringTok{ }\NormalTok{Must group by variables found }\ControlFlowTok{in} \StringTok{`}\DataTypeTok{.data}\StringTok{`}\NormalTok{.}
\OperatorTok{*}\StringTok{ }\NormalTok{Column }\StringTok{`}\DataTypeTok{study_area}\StringTok{`}\NormalTok{ is not found.}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{49}\NormalTok{] }\StringTok{"stratum_WHICEAS"}  \StringTok{"stratum_OtherCNP"} \StringTok{"study_area.x"}     \StringTok{"study_area.y"}    
\NormalTok{[}\DecValTok{53}\NormalTok{] }\StringTok{"stratum"}         
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{hist.default}\NormalTok{(cruz}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{default}\OperatorTok{$}\NormalTok{density}\OperatorTok{$}\NormalTok{segments}\OperatorTok{$}\NormalTok{dist, }\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\OperatorTok{:}\StringTok{ 'x'}\NormalTok{ must be numeric}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error}\OperatorTok{:}\StringTok{ }\ErrorTok{$}\StringTok{ }\NormalTok{operator is invalid }\ControlFlowTok{for}\NormalTok{ atomic vectors}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{<}\StringTok{ }\NormalTok{table of extent }\DecValTok{0} \OperatorTok{>}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{head}\NormalTok{(., }\DecValTok{20}\NormalTok{)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'cruz_demo'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{List of }\DecValTok{2}
 \OperatorTok{$}\StringTok{ }\NormalTok{default    }\OperatorTok{:}\StringTok{'data.frame'}\OperatorTok{:}\StringTok{    }\DecValTok{22370}\NormalTok{ obs. of  }\DecValTok{53}\NormalTok{ variables}\OperatorTok{:}
\StringTok{  }\NormalTok{..}\OperatorTok{$}\StringTok{ }\NormalTok{Event           }\OperatorTok{:}\StringTok{ }\NormalTok{chr   ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{DateTime        }\OperatorTok{:}\StringTok{ }\NormalTok{POSIXct, format}\OperatorTok{:}\StringTok{  }\NormalTok{...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{Lat             }\OperatorTok{:}\StringTok{ }\NormalTok{num  }\OtherTok{NULL}\NormalTok{ ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{Lon             }\OperatorTok{:}\StringTok{ }\NormalTok{num  }\OtherTok{NULL}\NormalTok{ ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{OnEffort        }\OperatorTok{:}\StringTok{ }\NormalTok{logi  }\OtherTok{NULL}\NormalTok{ ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{Cruise          }\OperatorTok{:}\StringTok{ }\NormalTok{num  }\OtherTok{NULL}\NormalTok{ ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{Mode            }\OperatorTok{:}\StringTok{ }\NormalTok{chr   ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{OffsetGMT       }\OperatorTok{:}\StringTok{ }\NormalTok{int  }\OtherTok{NULL}\NormalTok{ ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{EffType         }\OperatorTok{:}\StringTok{ }\NormalTok{chr   ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{ESWsides        }\OperatorTok{:}\StringTok{ }\NormalTok{num  }\OtherTok{NULL}\NormalTok{ ...}
\NormalTok{  .. [list output truncated]}
 \OperatorTok{$}\StringTok{ }\NormalTok{fkw_insular}\OperatorTok{:}\StringTok{'data.frame'}\OperatorTok{:}\StringTok{    }\DecValTok{22370}\NormalTok{ obs. of  }\DecValTok{53}\NormalTok{ variables}\OperatorTok{:}
\StringTok{  }\NormalTok{..}\OperatorTok{$}\StringTok{ }\NormalTok{Event           }\OperatorTok{:}\StringTok{ }\NormalTok{chr   ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{DateTime        }\OperatorTok{:}\StringTok{ }\NormalTok{POSIXct, format}\OperatorTok{:}\StringTok{  }\NormalTok{...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{Lat             }\OperatorTok{:}\StringTok{ }\NormalTok{num  }\OtherTok{NULL}\NormalTok{ ...}
\NormalTok{  ..}\OperatorTok{$}\StringTok{ }\NormalTok{Lon             }\OperatorTok{:}\StringTok{ }\NormalTok{num  }\OtherTok{NULL}\NormalTok{ ...}
...
\includegraphics{figures/unnamed-chunk-86-1.pdf} \includegraphics{figures/unnamed-chunk-86-2.pdf} \includegraphics{figures/unnamed-chunk-86-3.pdf}
...
\includegraphics{figures/unnamed-chunk-89-1.pdf} \includegraphics{figures/unnamed-chunk-89-2.pdf} \includegraphics{figures/unnamed-chunk-89-3.pdf} \includegraphics{figures/unnamed-chunk-89-4.pdf} \includegraphics{figures/unnamed-chunk-89-5.pdf}
...
\includegraphics{figures/unnamed-chunk-90-1.pdf} \includegraphics{figures/unnamed-chunk-90-2.pdf} \includegraphics{figures/unnamed-chunk-90-3.pdf} \includegraphics{figures/unnamed-chunk-90-4.pdf} \includegraphics{figures/unnamed-chunk-90-5.pdf} \includegraphics{figures/unnamed-chunk-90-6.pdf} \includegraphics{figures/unnamed-chunk-90-7.pdf} \includegraphics{figures/unnamed-chunk-90-8.pdf} \includegraphics{figures/unnamed-chunk-90-9.pdf} \includegraphics{figures/unnamed-chunk-90-10.pdf} \includegraphics{figures/unnamed-chunk-90-11.pdf} \includegraphics{figures/unnamed-chunk-90-12.pdf} \includegraphics{figures/unnamed-chunk-90-13.pdf} \includegraphics{figures/unnamed-chunk-90-14.pdf} \includegraphics{figures/unnamed-chunk-90-15.pdf} \includegraphics{figures/unnamed-chunk-90-16.pdf} \includegraphics{figures/unnamed-chunk-90-17.pdf} \includegraphics{figures/unnamed-chunk-90-18.pdf} \includegraphics{figures/unnamed-chunk-90-19.pdf} \includegraphics{figures/unnamed-chunk-90-20.pdf} \includegraphics{figures/unnamed-chunk-90-21.pdf} \includegraphics{figures/unnamed-chunk-90-22.pdf} \includegraphics{figures/unnamed-chunk-90-23.pdf} \includegraphics{figures/unnamed-chunk-90-24.pdf} \includegraphics{figures/unnamed-chunk-90-25.pdf} \includegraphics{figures/unnamed-chunk-90-26.pdf} \includegraphics{figures/unnamed-chunk-90-27.pdf} \includegraphics{figures/unnamed-chunk-90-28.pdf} \includegraphics{figures/unnamed-chunk-90-29.pdf} \includegraphics{figures/unnamed-chunk-90-30.pdf} \includegraphics{figures/unnamed-chunk-90-31.pdf} \includegraphics{figures/unnamed-chunk-90-32.pdf} \includegraphics{figures/unnamed-chunk-90-33.pdf} \includegraphics{figures/unnamed-chunk-90-34.pdf} \includegraphics{figures/unnamed-chunk-90-35.pdf} \includegraphics{figures/unnamed-chunk-90-36.pdf} \includegraphics{figures/unnamed-chunk-90-37.pdf} \includegraphics{figures/unnamed-chunk-90-38.pdf} \includegraphics{figures/unnamed-chunk-90-39.pdf} \includegraphics{figures/unnamed-chunk-90-40.pdf} \includegraphics{figures/unnamed-chunk-90-41.pdf} \includegraphics{figures/unnamed-chunk-90-42.pdf} \includegraphics{figures/unnamed-chunk-90-43.pdf} \includegraphics{figures/unnamed-chunk-90-44.pdf} \includegraphics{figures/unnamed-chunk-90-45.pdf} \includegraphics{figures/unnamed-chunk-90-46.pdf} \includegraphics{figures/unnamed-chunk-90-47.pdf} \includegraphics{figures/unnamed-chunk-90-48.pdf} \includegraphics{figures/unnamed-chunk-90-49.pdf} \includegraphics{figures/unnamed-chunk-90-50.pdf} \includegraphics{figures/unnamed-chunk-90-51.pdf} \includegraphics{figures/unnamed-chunk-90-52.pdf} \includegraphics{figures/unnamed-chunk-90-53.pdf} \includegraphics{figures/unnamed-chunk-90-54.pdf} \includegraphics{figures/unnamed-chunk-90-55.pdf} \includegraphics{figures/unnamed-chunk-90-56.pdf} \includegraphics{figures/unnamed-chunk-90-57.pdf} \includegraphics{figures/unnamed-chunk-90-58.pdf} \includegraphics{figures/unnamed-chunk-90-59.pdf} \includegraphics{figures/unnamed-chunk-90-60.pdf} \includegraphics{figures/unnamed-chunk-90-61.pdf} \includegraphics{figures/unnamed-chunk-90-62.pdf} \includegraphics{figures/unnamed-chunk-90-63.pdf} \includegraphics{figures/unnamed-chunk-90-64.pdf} \includegraphics{figures/unnamed-chunk-90-65.pdf} \includegraphics{figures/unnamed-chunk-90-66.pdf} \includegraphics{figures/unnamed-chunk-90-67.pdf} \includegraphics{figures/unnamed-chunk-90-68.pdf} \includegraphics{figures/unnamed-chunk-90-69.pdf} \includegraphics{figures/unnamed-chunk-90-70.pdf}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{nrow}\NormalTok{(.)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'cruz_demo'}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{segment_histogram}\NormalTok{(cruz_demo}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{default}\OperatorTok{$}\NormalTok{density)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'cruz_demo'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{segment_histogram}\NormalTok{(cruz_demo}\OperatorTok{$}\NormalTok{cohorts}\OperatorTok{$}\NormalTok{default}\OperatorTok{$}\NormalTok{density, }\DataTypeTok{by_day =} \OtherTok{TRUE}\NormalTok{)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'cruz_demo'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
