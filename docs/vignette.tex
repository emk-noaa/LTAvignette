...
\subsubsection*{Recent changes}\label{recent-changes}}
\addcontentsline{toc}{subsubsection}{Recent changes}

\begin{itemize}
\item
  New \texttt{format\_distance()} function creates tables that match \texttt{EFFORT.csv} and \texttt{SIGHTINGS.csv}.
\item
...
\ErrorTok{$}\StringTok{ }\NormalTok{yday         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{21}\NormalTok{, }\DecValTok{22}\NormalTok{, }\DecValTok{39}\NormalTok{, }\DecValTok{68}\NormalTok{, }\DecValTok{22}\NormalTok{, }\DecValTok{19}\NormalTok{, }\DecValTok{19}\NormalTok{, }\DecValTok{19}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DecValTok{21}\NormalTok{, }\DecValTok{22}\NormalTok{, }\DecValTok{23}\NormalTok{, }\DecValTok{23}\NormalTok{, }\DecValTok{2}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{dist         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{3.2237470}\NormalTok{, }\FloatTok{0.6118778}\NormalTok{, }\FloatTok{29.7257476}\NormalTok{, }\FloatTok{19.8973176}\NormalTok{, }\FloatTok{1.2231556}\NormalTok{, }\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{22.33300}\NormalTok{, }\FloatTok{22.68750}\NormalTok{, }\FloatTok{20.79283}\NormalTok{, }\FloatTok{21.65833}\NormalTok{, }\FloatTok{22.68750}\NormalTok{, }\FloatTok{21.8520}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon1         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-161.2520}\NormalTok{, }\FloatTok{-161.1208}\NormalTok{, }\FloatTok{-153.6117}\NormalTok{, }\FloatTok{-161.7810}\NormalTok{, }\FloatTok{-161.1208}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
...
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp1   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1579591728}\NormalTok{, }\DecValTok{1579678921}\NormalTok{, }\DecValTok{1581144814}\NormalTok{, }\DecValTok{1583688255}\NormalTok{, }\DecValTok{157967892}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lat2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{22.68750}\NormalTok{, }\FloatTok{20.79217}\NormalTok{, }\FloatTok{21.65683}\NormalTok{, }\FloatTok{21.66717}\NormalTok{, }\FloatTok{22.68617}\NormalTok{, }\FloatTok{22.1771}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{lon2         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-161.1208}\NormalTok{, }\FloatTok{-153.6090}\NormalTok{, }\FloatTok{-161.7753}\NormalTok{, }\FloatTok{-161.9295}\NormalTok{, }\FloatTok{-161.1158}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
...
\ErrorTok{$}\StringTok{ }\NormalTok{timestamp2   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1579678921}\NormalTok{, }\DecValTok{1581144694}\NormalTok{, }\DecValTok{1583688135}\NormalTok{, }\DecValTok{1583692815}\NormalTok{, }\DecValTok{157967903}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlat         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{22.69117}\NormalTok{, }\FloatTok{20.79133}\NormalTok{, }\FloatTok{21.62583}\NormalTok{, }\FloatTok{21.68417}\NormalTok{, }\FloatTok{22.68750}\NormalTok{, }\FloatTok{22.2345}\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{mlon         }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{-161.1353}\NormalTok{, }\FloatTok{-153.6063}\NormalTok{, }\FloatTok{-161.6553}\NormalTok{, }\FloatTok{-161.8822}\NormalTok{, }\FloatTok{-161.1208}\NormalTok{, }\DecValTok{-1}\OperatorTok{~}
...
\ErrorTok{$}\StringTok{ }\NormalTok{mtimestamp   }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1579591728}\NormalTok{, }\DecValTok{1579678921}\NormalTok{, }\DecValTok{1581144814}\NormalTok{, }\DecValTok{1583688255}\NormalTok{, }\DecValTok{157967892}\OperatorTok{~}
...
\ErrorTok{$}\StringTok{ }\NormalTok{Mode         }\OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{ }\OtherTok{NA}\NormalTok{, }\StringTok{"P"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\StringTok{"P"}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\OperatorTok{~}
\ErrorTok{$}\StringTok{ }\NormalTok{EffType      }\OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{ }\OtherTok{NA}\NormalTok{, }\StringTok{"S"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\StringTok{"S"}\NormalTok{, }\StringTok{"S"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\StringTok{"N"}\NormalTok{, }\StringTok{"F"}\NormalTok{, }\OtherTok{NA}\NormalTok{, }\StringTok{"S"}\NormalTok{, }\StringTok{"F"}\NormalTok{, }\StringTok{"S"}\NormalTok{, }\StringTok{"~}
\StringTok{$ ESWsides     <dbl> NA, 2, NA, 2, 2, NA, 2, 2, NA, 2, 2, 2, 2, 2, NA, 2, 2, 2~}
...
\StringTok{$ day          <int> 21, 22, 8, 8, 22, 19, 19, 19, 20, 20, 21, 22, 23, 23, 24,~}
\StringTok{$ min_line     <int> 1080, 1549, 9811, 20825, 1550, 11, 240, 601, 701, 963, 14~}
\StringTok{$ max_line     <int> 1548, 9810, 20824, 20886, 1554, 239, 499, 700, 962, 1486,~}
\StringTok{$ n_rows       <int> 14, 3, 58, 62, 5, 103, 120, 99, 111, 164, 117, 89, 90, 59~}
\StringTok{$ avgBft       <dbl> NaN, NaN, 7.000000, 6.418047, 2.000000, 5.150894, 4.84389~}
\StringTok{$ avgSwellHght <dbl> NaN, NaN, 7.000000, 7.000000, 4.000000, 7.433929, 7.20666~}
\StringTok{$ avgHorizSun  <dbl> NaN, NaN, 10.958794, 11.000000, NaN, 6.954993, 6.314060, ~}
\StringTok{$ avgVertSun   <dbl> NaN, NaN, 1.058675, 2.418106, NaN, 1.419236, 1.178142, 2.~}
\StringTok{$ avgGlare     <dbl> NaN, NaN, 0.05867486, 1.00000000, NaN, 0.00000000, 0.4734~}
\StringTok{$ avgVis       <dbl> 4.000000, NaN, 5.000000, 4.709023, 6.200000, 5.641518, 6.~}
\StringTok{$ avgCourse    <dbl> NaN, NaN, 287.23315, 269.55972, 105.00000, 247.16155, 166~}
\StringTok{$ avgSpdKt     <dbl> NaN, NaN, 9.968032, 9.315076, 9.000000, 8.964329, 8.18859~}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{45}\NormalTok{] }\StringTok{"km_int"}           \StringTok{"km_cum"}           \StringTok{"ship"}             \StringTok{"stratum_HI_EEZ"}  
\NormalTok{[}\DecValTok{49}\NormalTok{] }\StringTok{"stratum_WHICEAS"}  \StringTok{"stratum_OtherCNP"} \StringTok{"study_area"}       \StringTok{"stratum"}         
...
\NormalTok{[}\DecValTok{33}\NormalTok{] }\StringTok{"km_int"}           \StringTok{"km_cum"}           \StringTok{"ship"}             \StringTok{"stratum_HI_EEZ"}  
\NormalTok{[}\DecValTok{37}\NormalTok{] }\StringTok{"stratum_WHICEAS"}  \StringTok{"stratum_OtherCNP"} \StringTok{"study_area"}       \StringTok{"stratum"}         
...
\StringTok{$ ship             <chr> "}\NormalTok{OES}\StringTok{", "}\NormalTok{OES}\StringTok{", "}\NormalTok{OES}\StringTok{", "}\NormalTok{OES}\StringTok{", "}\NormalTok{OES}\StringTok{"}
...
\OperatorTok{$}\StringTok{ }\NormalTok{ss_tot           }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\FloatTok{32.800869}\NormalTok{, }\FloatTok{32.800869}\NormalTok{, }\FloatTok{1.000000}\NormalTok{, }\FloatTok{13.913043}\NormalTok{, }\FloatTok{6.956522}
\OperatorTok{$}\StringTok{ }\NormalTok{ss_percent       }\OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\OtherTok{NaN}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"total"}            \StringTok{"total_by_effort"}  \StringTok{"total_by_stratum"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-85-1.pdf} \includegraphics{figures/unnamed-chunk-85-2.pdf} \includegraphics{figures/unnamed-chunk-85-3.pdf}
...
\includegraphics{figures/unnamed-chunk-88-1.pdf} \includegraphics{figures/unnamed-chunk-88-2.pdf} \includegraphics{figures/unnamed-chunk-88-3.pdf} \includegraphics{figures/unnamed-chunk-88-4.pdf} \includegraphics{figures/unnamed-chunk-88-5.pdf}
...
\includegraphics{figures/unnamed-chunk-89-1.pdf} \includegraphics{figures/unnamed-chunk-89-2.pdf} \includegraphics{figures/unnamed-chunk-89-3.pdf} \includegraphics{figures/unnamed-chunk-89-4.pdf} \includegraphics{figures/unnamed-chunk-89-5.pdf} \includegraphics{figures/unnamed-chunk-89-6.pdf} \includegraphics{figures/unnamed-chunk-89-7.pdf} \includegraphics{figures/unnamed-chunk-89-8.pdf} \includegraphics{figures/unnamed-chunk-89-9.pdf} \includegraphics{figures/unnamed-chunk-89-10.pdf} \includegraphics{figures/unnamed-chunk-89-11.pdf} \includegraphics{figures/unnamed-chunk-89-12.pdf} \includegraphics{figures/unnamed-chunk-89-13.pdf} \includegraphics{figures/unnamed-chunk-89-14.pdf} \includegraphics{figures/unnamed-chunk-89-15.pdf} \includegraphics{figures/unnamed-chunk-89-16.pdf} \includegraphics{figures/unnamed-chunk-89-17.pdf} \includegraphics{figures/unnamed-chunk-89-18.pdf} \includegraphics{figures/unnamed-chunk-89-19.pdf} \includegraphics{figures/unnamed-chunk-89-20.pdf} \includegraphics{figures/unnamed-chunk-89-21.pdf} \includegraphics{figures/unnamed-chunk-89-22.pdf} \includegraphics{figures/unnamed-chunk-89-23.pdf} \includegraphics{figures/unnamed-chunk-89-24.pdf} \includegraphics{figures/unnamed-chunk-89-25.pdf} \includegraphics{figures/unnamed-chunk-89-26.pdf} \includegraphics{figures/unnamed-chunk-89-27.pdf} \includegraphics{figures/unnamed-chunk-89-28.pdf} \includegraphics{figures/unnamed-chunk-89-29.pdf} \includegraphics{figures/unnamed-chunk-89-30.pdf} \includegraphics{figures/unnamed-chunk-89-31.pdf} \includegraphics{figures/unnamed-chunk-89-32.pdf} \includegraphics{figures/unnamed-chunk-89-33.pdf} \includegraphics{figures/unnamed-chunk-89-34.pdf} \includegraphics{figures/unnamed-chunk-89-35.pdf} \includegraphics{figures/unnamed-chunk-89-36.pdf} \includegraphics{figures/unnamed-chunk-89-37.pdf} \includegraphics{figures/unnamed-chunk-89-38.pdf} \includegraphics{figures/unnamed-chunk-89-39.pdf} \includegraphics{figures/unnamed-chunk-89-40.pdf} \includegraphics{figures/unnamed-chunk-89-41.pdf} \includegraphics{figures/unnamed-chunk-89-42.pdf} \includegraphics{figures/unnamed-chunk-89-43.pdf} \includegraphics{figures/unnamed-chunk-89-44.pdf} \includegraphics{figures/unnamed-chunk-89-45.pdf} \includegraphics{figures/unnamed-chunk-89-46.pdf} \includegraphics{figures/unnamed-chunk-89-47.pdf} \includegraphics{figures/unnamed-chunk-89-48.pdf} \includegraphics{figures/unnamed-chunk-89-49.pdf} \includegraphics{figures/unnamed-chunk-89-50.pdf} \includegraphics{figures/unnamed-chunk-89-51.pdf} \includegraphics{figures/unnamed-chunk-89-52.pdf} \includegraphics{figures/unnamed-chunk-89-53.pdf} \includegraphics{figures/unnamed-chunk-89-54.pdf} \includegraphics{figures/unnamed-chunk-89-55.pdf} \includegraphics{figures/unnamed-chunk-89-56.pdf} \includegraphics{figures/unnamed-chunk-89-57.pdf} \includegraphics{figures/unnamed-chunk-89-58.pdf} \includegraphics{figures/unnamed-chunk-89-59.pdf} \includegraphics{figures/unnamed-chunk-89-60.pdf} \includegraphics{figures/unnamed-chunk-89-61.pdf} \includegraphics{figures/unnamed-chunk-89-62.pdf} \includegraphics{figures/unnamed-chunk-89-63.pdf} \includegraphics{figures/unnamed-chunk-89-64.pdf} \includegraphics{figures/unnamed-chunk-89-65.pdf} \includegraphics{figures/unnamed-chunk-89-66.pdf} \includegraphics{figures/unnamed-chunk-89-67.pdf} \includegraphics{figures/unnamed-chunk-89-68.pdf} \includegraphics{figures/unnamed-chunk-89-69.pdf} \includegraphics{figures/unnamed-chunk-89-70.pdf}
...
\item
  Check to make sure that you have added geometric mean option in \texttt{process\_sightings()}, even if geometric WEIGHTED mean is not possible.
\item
