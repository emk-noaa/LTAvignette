...
\DecValTok{4}\NormalTok{   Fraser}\StringTok{'s dolphin     026 HI-EEZ 2454639 2017      140 17260.92     52088.13}
\StringTok{5 Melon-headed whale     026 HI-EEZ 2454639 2010      142 17957.44     64201.13}
\StringTok{6 Melon-headed whale     026 HI-EEZ 2454639 2017      140 17260.92     52088.13}
\StringTok{  ESW_mean  n g0_est  ER_clusters    D_clusters N_clusters size_mean   size_sd}
\StringTok{1 3.497191 19   0.33 0.0010580573 0.00047091315  1155.9220  51.37295  47.24913}
\StringTok{2 4.010296 16   0.32 0.0009269493 0.00037062119   909.7414  36.85783  17.52562}
\StringTok{3 3.575183  3   0.33 0.0001670617 0.00007110128   174.5280 236.20106 128.98893}
\StringTok{4 3.017691  2   0.32 0.0001158687 0.00006035535   148.1506 355.63200  91.38621}
\StringTok{5 3.575183  3   0.33 0.0001670617 0.00007110128   174.5280 236.20106 128.98893}
\StringTok{6 3.017691  2   0.32 0.0001158687 0.00006035535   148.1506 355.63200  91.38621}
\StringTok{          ER          D        N}
\StringTok{1 0.05435552 0.02261271 55506.05}
\StringTok{2 0.03416534 0.01311434 32190.98}
\StringTok{3 0.03946014 0.01706694 41893.18}
\StringTok{4 0.04120660 0.02116271 51946.83}
\StringTok{5 0.03946014 0.01706694 41893.18}
\StringTok{6 0.04120660 0.02116271 51946.83}
\end{Highlighting}
\end{Shaded}
...
To plot the best-fit detection model for a species pool, use the \texttt{plot\_df()} function.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_df}\NormalTok{(lta_result)}
\end{Highlighting}
\end{Shaded}
...
\ldots{} which we can combine using the function \texttt{cruz\_combine()}:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cruzes <-}\StringTok{ }\KeywordTok{list}\NormalTok{(cnp_}\DecValTok{1986}\NormalTok{_}\DecValTok{2020}\NormalTok{_10km,}
\NormalTok{               ccs_}\DecValTok{1986}\NormalTok{_}\DecValTok{2020}\NormalTok{_10km)}

\NormalTok{cruz <-}\StringTok{ }\KeywordTok{cruz_combine}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-135-1.pdf} \includegraphics{figures/unnamed-chunk-135-2.pdf} \includegraphics{figures/unnamed-chunk-135-3.pdf}
...
\includegraphics{figures/unnamed-chunk-138-1.pdf} \includegraphics{figures/unnamed-chunk-138-2.pdf} \includegraphics{figures/unnamed-chunk-138-3.pdf} \includegraphics{figures/unnamed-chunk-138-4.pdf} \includegraphics{figures/unnamed-chunk-138-5.pdf}
