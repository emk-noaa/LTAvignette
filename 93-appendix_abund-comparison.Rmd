...
`LTabundR` is about 6x slower than `ABUND` (e.g., for CNP 1986 - 2020 surveys, ABUND processes in 50 seconds). `LTabundR` processes in 5:00 minutes). This lag is due to the facts that…
