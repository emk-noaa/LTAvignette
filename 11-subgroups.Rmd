...
Here is an example of a valid `Rg0` input based on the values reported for false killer whales in [Bradford et al. (2020)](https://www.fisheries.noaa.gov/inport/item/59592).  
...
3. Estimates the geometric mean subgroup size based on the `ss` input.  
