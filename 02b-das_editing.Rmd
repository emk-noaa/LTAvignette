...
To demonstrate the types of editing actions that can be achieved through `das_editor()`, we will use the `DAS` file from the 2020 WHICEAS survey (you can download [here](https://raw.githubusercontent.com/emk-noaa/LTAvignette/main/data/surveys/HICEASwinter2020.das?token=GHSAT0AAAAAACFPESQVZWKAJE3NCRQBC4SCZGRJNLA)).  
